      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .as-aside {
          ...
          background: linear-gradient(160deg, #1a0533 0%, #2d0a5e 40%, #4a1272 70%, #6b21a8 100%);
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
                <div>
                  ...
                  <div style={{ position:"relative" }}>
                    <span style={{ position:"absolute", left:13, top:"50%", transform:"translateY(-50%)", color:"#c4b5d1", fontSize:15 }}>
                      <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" width="15" height="15"><circle cx="8" cy="5" r="3"/><path d="M2 14c0-3 2.5-5 6-5s6 2 6 5" strokeLinecap="round"/></svg>
                    </span>
                    <input
                      className="as-input"
                ...
                <div>
                  ...
                  <div style={{ position:"relative" }}>
                    <span style={{ position:"absolute", left:13, top:"50%", transform:"translateY(-50%)", color:"#c4b5d1" }}>
                      <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" width="15" height="15"><path d="M3 2h3l1.5 3.5-1.8 1a9 9 0 004.8 4.8l1-1.8L15 11v3a1 1 0 01-1 1A13 13 0 012 3a1 1 0 011-1z" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    </span>
                    <input
                      className="as-input"
                      style={{ paddingLeft:38 }}
