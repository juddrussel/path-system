...
.path-audit-app{display:flex;min-height:100vh;background:#f8f7ff;color:#2c2537;font-family:'DM Sans',sans-serif}.path-audit-app *{box-sizing:border-box}.path-audit-app button,.path-audit-app input,.path-audit-app select{font-family:'DM Sans',sans-serif}.material-symbols-outlined{font-variation-settings:'FILL' 0,'wght' 400,'GRAD' 0,'opsz' 20;vertical-align:middle}.path-audit-main{display:flex;min-width:0;flex:1;flex-direction:column;background:#f8f7ff}.path-audit-content{width:100%;max-width:1540px;min-height:calc(100vh - 56px);margin:0 auto;padding:32px clamp(34px,4vw,56px) 50px;overflow:auto;background:radial-gradient(circle at 94% 0,rgba(196,181,253,.2),transparent 30rem),#f8f7ff}.path-audit-view{width:100%;max-width:1380px;margin:0 auto}.path-audit-kicker{display:flex;align-items:center;gap:7px;color:#9d95a8;font:800 9px/1 'DM Sans',sans-serif;letter-spacing:.05em;text-transform:uppercase}.path-audit-kicker i,.path-audit-hero .path-audit-kicker i{width:6px;height:6px;border-radius:1px;background:#c4b5fd;transform:rotate(45deg)}.path-audit-hero{display:flex;align-items:flex-end;justify-content:space-between;gap:24px;margin-bottom:20px;padding:27px 25px 25px;border:1px solid #e6ddf5;border-radius:12px;background:linear-gradient(118deg,#fbf9ff,#f4edff)}.path-audit-hero h1{margin:9px 0 6px;color:#2c2537;font:800 32px/1 Manrope,sans-serif;letter-spacing:-.04em}.path-audit-hero p{margin:0;color:#83778b;font:13px/1.45 'DM Sans',sans-serif}.path-audit-hero-badge{display:flex;align-items:center;gap:9px;padding:11px 13px;border:1px solid #dfd2f1;border-radius:8px;background:#fff;color:#6d3ec5}.path-audit-hero-badge span{display:flex;flex-direction:column;gap:2px}.path-audit-hero-badge strong{font:700 10px Manrope,sans-serif}.path-audit-hero-badge small{color:#a097a8;font:9px 'DM Sans',sans-serif}.path-audit-stat-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:13px;margin-bottom:20px}.path-audit-stat{position:relative;overflow:hidden;padding:17px 18px;border:1px solid #e7e2ef;border-radius:9px;background:#fff;box-shadow:0 10px 28px #39245d0a}.path-audit-stat>span,.path-audit-stat small{color:#9990a1;font:10px 'DM Sans',sans-serif}.path-audit-stat strong{display:block;margin:9px 0 4px;color:#352d40;font:700 25px/1 Manrope,sans-serif;letter-spacing:-.04em}.path-audit-stat small{display:block;min-height:14px}.path-audit-stat>i{position:absolute;right:15px;top:16px;color:#a78bfa;font-size:18px}.path-audit-stat-blue>i{color:#6793c9}.path-audit-stat-amber>i{color:#c38b32}.path-audit-stat-red>i{color:#c56767}.path-audit-toolbar{display:flex;align-items:center;gap:9px;margin-bottom:14px}.path-audit-search{display:flex;align-items:center;gap:8px;min-width:210px;flex:1;height:35px;padding:0 10px;border:1px solid #e4deec;border-radius:7px;background:#fff;color:#9b90a2}.path-audit-search input{width:100%;border:0;outline:0;background:transparent;color:#665a70;font:10px 'DM Sans',sans-serif}.path-audit-toolbar select,.path-audit-date{height:35px;max-width:146px;border:1px solid #e4deec;border-radius:7px;padding:0 8px;outline:0;background:#fff;color:#786d81;font:700 9px 'DM Sans',sans-serif;cursor:pointer}.path-audit-date{max-width:142px}.path-audit-filter-group{display:flex;gap:4px;flex-wrap:wrap}.path-audit-filter-group button{padding:9px 10px;border:1px solid #e5deed;border-radius:6px;background:#fff;color:#978c9e;font:700 9px 'DM Sans',sans-serif;cursor:pointer}.path-audit-filter-group button.active,.path-audit-filter-group button:hover{border-color:#d5c0f5;background:#f3edff;color:#6d3ec5}.path-audit-clear{display:grid;width:34px;height:34px;flex:none;border:0;border-radius:7px;place-items:center;background:transparent;color:#958a9c;cursor:pointer}.path-audit-clear:hover{background:#f1ebff;color:#6d3ec5}.path-audit-clear:disabled{cursor:not-allowed;opacity:.4}.path-audit-export,.path-audit-primary{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:35px;flex:none;border:0;border-radius:7px;padding:0 11px;background:#7c3aed;color:#fff;font:800 10px 'DM Sans',sans-serif;cursor:pointer;box-shadow:0 7px 17px rgba(124,58,237,.16)}.path-audit-export:hover,.path-audit-primary:hover{background:#6d28d9}.path-audit-error{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:14px;border:1px solid #f0c7c7;border-radius:8px;padding:10px 12px;background:#fff5f5;color:#a63e3e;font:10px 'DM Sans',sans-serif}.path-audit-error button{display:inline-flex;align-items:center;gap:5px;border:0;background:transparent;color:inherit;font:800 9px 'DM Sans',sans-serif;cursor:pointer}.path-audit-layout{display:grid;grid-template-columns:minmax(0,1.6fr) minmax(280px,.72fr);gap:14px}.path-audit-ledger,.path-audit-detail{overflow:hidden;border:1px solid #e5deed;border-radius:12px;background:#fff;box-shadow:0 12px 30px rgba(57,36,93,.045)}.path-audit-ledger-heading{display:flex;align-items:center;justify-content:space-between;padding:19px}.path-audit-ledger-heading h2{margin:7px 0 0;color:#3b3245;font:700 18px/1 Manrope,sans-serif;letter-spacing:-.035em}.path-audit-ledger-heading h2 b{display:inline-grid;width:25px;height:20px;margin-left:5px;place-items:center;border-radius:5px;background:#f0e8fc;color:#7445c6;font:800 9px 'DM Sans',sans-serif;vertical-align:middle}.path-audit-retention{display:flex;align-items:center;gap:5px;color:#9b91a2;font:9px 'DM Sans',sans-serif}.path-audit-table-head,.path-audit-record{display:grid;grid-template-columns:minmax(240px,1.55fr) minmax(150px,1fr) 105px 125px;gap:14px;align-items:center}.path-audit-table-head{padding:9px 19px;border-top:1px solid #f0edf4;border-bottom:1px solid #f0edf4;color:#aaa0ad;font:800 8px 'DM Sans',sans-serif;letter-spacing:.08em;text-transform:uppercase}.path-audit-record{width:100%;min-height:0;border:0;border-bottom:1px solid #f0edf4;padding:14px 19px;background:#fff;color:inherit;text-align:left;cursor:pointer}.path-audit-record:hover,.path-audit-record.selected{background:#fbf9ff}.path-audit-record.selected{box-shadow:inset 2px 0 #7c3aed}.path-audit-activity,.path-audit-actor{display:flex;min-width:0;align-items:center;gap:9px}.path-audit-activity>i{display:grid;width:31px;height:31px;flex:none;border-radius:9px;place-items:center;background:#eee7fd;color:#7547c9;font-size:17px}.path-audit-activity>i.failed{background:#fff0f0;color:#bb5959}.path-audit-activity>span:last-child,.path-audit-actor>span:last-child{display:flex;min-width:0;flex-direction:column;gap:3px}.path-audit-activity strong,.path-audit-actor strong{overflow:hidden;color:#5b4f64;font:700 10px/1.2 Manrope,sans-serif;text-overflow:ellipsis;white-space:nowrap}.path-audit-activity small,.path-audit-actor small{overflow:hidden;color:#a49aa8;font:8px/1.25 'DM Sans',sans-serif;text-overflow:ellipsis;white-space:nowrap}.path-audit-avatar{display:grid;width:29px;height:29px;flex:none;border:1px solid #ebe5f1;border-radius:8px;place-items:center;object-fit:cover;font:800 8px 'DM Sans',sans-serif}.path-audit-type{width:max-content;padding:5px 7px;border-radius:5px;background:#eee7fd;color:#7650be;font:800 8px 'DM Sans',sans-serif}.path-audit-type.failed{background:#fff0f0;color:#b54d4d}.path-audit-time{display:flex;flex-direction:column;gap:3px;color:#aaa0ad;font:8px/1.25 'DM Sans',sans-serif}.path-audit-time b{color:#908695;font:800 9px 'DM Sans',sans-serif}.path-audit-pagination{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:13px 18px;background:#fcfbfe;color:#9990a1;font:9px 'DM Sans',sans-serif}.path-audit-pagination>div{display:flex;align-items:center;gap:6px}.path-audit-pages{display:flex;gap:4px}.path-audit-page-arrow,.path-audit-pages button{display:inline-flex;align-items:center;justify-content:center;gap:4px;height:28px;border:1px solid #e4deec;border-radius:6px;background:#fff;color:#83778d;font:700 9px 'DM Sans',sans-serif;cursor:pointer}.path-audit-page-arrow{padding:0 9px}.path-audit-pages button{width:28px}.path-audit-page-arrow:hover:not(:disabled),.path-audit-pages button:hover,.path-audit-pages button.active{border-color:#d4c0f5;background:#f2ebff;color:#6d3ec5}.path-audit-page-arrow:disabled{cursor:not-allowed;opacity:.42}.path-audit-detail{padding:20px}.path-audit-detail-icon{display:grid;width:43px;height:43px;margin:20px 0 12px;border-radius:12px;place-items:center;background:#eee7fd;color:#7044c5}.path-audit-detail-icon.failed{background:#fff0f0;color:#bb5959}.path-audit-detail h2{margin:0;color:#3b3245;font:700 17px/1.2 Manrope,sans-serif;letter-spacing:-.035em}.path-audit-detail>p{margin:6px 0 18px;color:#918696;font:10px/1.45 'DM Sans',sans-serif}.path-audit-detail-status{display:flex;align-items:center;justify-content:space-between;border-radius:7px;padding:11px 12px;background:#f8f4ff}.path-audit-detail-status span,.path-audit-detail-meta span,.path-audit-detail-actor span{color:#a39aa9;font:8px 'DM Sans',sans-serif}.path-audit-detail-status strong{color:#6d3ec5;font:700 10px Manrope,sans-serif}.path-audit-detail-status strong.failed{color:#b54d4d}.path-audit-detail-meta{display:grid;grid-template-columns:1fr 1fr;gap:16px 12px;margin:20px 0;padding:16px 0;border-top:1px solid #f0edf4;border-bottom:1px solid #f0edf4}.path-audit-detail-meta div,.path-audit-detail-actor div{display:flex;min-width:0;flex-direction:column;gap:4px}.path-audit-detail-meta strong,.path-audit-detail-actor strong{overflow:hidden;color:#63566b;font:700 9px/1.3 Manrope,sans-serif;text-overflow:ellipsis}.path-audit-detail-actor{display:flex;align-items:center;gap:9px}.path-audit-document-link{display:inline-flex;align-items:center;gap:6px;margin-top:18px;border:0;background:transparent;color:#6e40c3;font:800 9px 'DM Sans',sans-serif;cursor:pointer}.path-audit-detail-note{display:flex;gap:7px;margin-top:19px;border-radius:7px;padding:10px;background:#fbf9ff;color:#8e82a3;font:8px/1.4 'DM Sans',sans-serif}.path-audit-empty{display:flex;align-items:center;flex-direction:column;gap:7px;padding:70px 20px;color:#a49aa8;text-align:center}.path-audit-empty strong{color:#62566c;font:700 12px Manrope,sans-serif}.path-audit-empty span{font:9px 'DM Sans',sans-serif}.path-audit-detail-empty{min-height:420px;justify-content:center}.path-audit-spin{animation:pathAuditSpin .8s linear infinite}@keyframes pathAuditSpin{to{transform:rotate(360deg)}}.path-audit-denied{display:flex;min-height:55vh;flex:1;align-items:center;flex-direction:column;justify-content:center;gap:10px;padding:40px;color:#827789;text-align:center}.path-audit-denied>svg{color:#7c3aed}.path-audit-denied h2{margin:0;color:#3b3245;font:700 18px Manrope,sans-serif}.path-audit-denied p{margin:0;font:10px 'DM Sans',sans-serif}.path-audit-footer{display:flex;align-items:center;justify-content:space-between;border-top:1px solid #e5deed;padding:10px 20px;background:#fff;color:#9e95a6;font:8px 'DM Sans',sans-serif}.path-audit-footer>span:last-child{display:flex;align-items:center;gap:5px}.path-audit-footer i{width:6px;height:6px;border-radius:50%;background:#4fa174}
...
@media(max-width:900px){.path-audit-hero{align-items:flex-start;flex-direction:column}.path-audit-stat-grid{grid-template-columns:repeat(2,1fr)}.path-audit-table-head{display:none}.path-audit-record{grid-template-columns:minmax(0,1fr) auto;gap:10px}.path-audit-record>.path-audit-actor{grid-column:1;grid-row:2}.path-audit-record>.path-audit-type{grid-column:2;grid-row:2;justify-self:end}.path-audit-record>.path-audit-time{grid-column:2;grid-row:1;align-items:flex-end}.path-audit-retention{display:none}.path-audit-pagination{align-items:flex-start;flex-direction:column}.path-audit-pagination>div{width:100%;justify-content:space-between}}
@media(max-width:640px){.path-audit-content{padding:20px 16px 34px}.path-audit-hero{padding:21px 18px}.path-audit-hero h1{font-size:27px}.path-audit-hero-badge{width:100%}.path-audit-stat-grid{gap:9px}.path-audit-stat{padding:13px}.path-audit-stat strong{font-size:21px}.path-audit-toolbar{gap:7px}.path-audit-search{min-width:100%}.path-audit-filter-group{width:100%;overflow:auto;flex-wrap:nowrap;padding-bottom:3px}.path-audit-filter-group button{white-space:nowrap}.path-audit-toolbar select,.path-audit-date{max-width:calc(50% - 4px);flex:1}.path-audit-export{margin-left:auto}.path-audit-record{padding:13px 14px}.path-audit-activity strong{font-size:9px}.path-audit-pagination{padding:12px 14px}.path-audit-page-arrow{padding:0 7px;font-size:0}.path-audit-page-arrow svg{margin:0}.path-audit-pages{flex:1;justify-content:center}.path-audit-detail{padding:17px}.path-audit-footer{align-items:flex-start;flex-direction:column;gap:6px;padding:10px 16px}}
`;
