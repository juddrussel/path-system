...
@media(max-width:900px){.path-audit-hero{align-items:flex-start;flex-direction:column;min-height:0}.path-audit-stat-grid{grid-template-columns:repeat(2,1fr)}.path-audit-table-head{display:none}.path-audit-record{grid-template-columns:1fr;gap:10px;grid-template-rows:auto auto auto}.path-audit-record>.path-audit-activity{grid-column:1;grid-row:1;min-width:0}.path-audit-record>.path-audit-actor{grid-column:1;grid-row:2}.path-audit-record>.path-audit-time{grid-column:1;grid-row:3;font-size:11px}.path-audit-record>.path-audit-type{display:none}.path-audit-retention{display:none}.path-audit-pagination{align-items:flex-start;flex-direction:column}.path-audit-pagination>div{width:100%;justify-content:space-between}}
