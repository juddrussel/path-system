    ...
    >
      <section className="faculty-dashboard-hero">
        ...
        <div style={{
          ...
          backgroundSize: "18px 18px", borderRadius: "inherit",
        }} />
        {/* glow orb */}
        <div style={{
          position: "absolute", top: -40, right: -20, width: 200, height: 200,
          borderRadius: "50%", background: "#a855f7", opacity: 0.25,
