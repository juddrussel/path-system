      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: "#f8f7ff",
            overflowY: "auto",
            padding: isFacultyDashboard ? 0 : "28px 48px 44px 88px",
