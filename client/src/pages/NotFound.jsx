  ...
  return (
    <main className="path-not-found">
      <style>{`
        ...
        .path-not-found-left{position:relative}.path-not-found-index{display:flex;align-items:center;gap:9px;color:#8f79a2;font-size:9px;font-weight:800;letter-spacing:.15em;text-transform:uppercase;font-family:"Manrope",Arial,sans-serif}.path-not-found-index::before{width:8px;height:8px;border-radius:50%;background:#7c3aed;content:""}.path-not-found-code{margin:23px 0 0;color:#7c3aed;font-size:clamp(142px,19vw,285px);font-weight:800;font-family:"Manrope",Arial,sans-serif;line-height:.74;letter-spacing:-.12em;text-shadow:0 15px 32px rgba(124,58,237,.13)}.path-not-found-left h1{max-width:590px;margin:36px 0 0;color:#33293c;font-size:clamp(34px,4.6vw,65px);font-weight:800;font-family:"Manrope",Arial,sans-serif;line-height:.99;letter-spacing:-.07em}.path-not-found-left h1 em{color:#7c3aed;font-family:Georgia,"Times New Roman",serif;font-weight:500;font-style:normal}.path-not-found-left>p{max-width:470px;margin:19px 0 0;color:#82768a;font-size:13px;line-height:1.75;font-family:"Manrope",Arial,sans-serif}
        .path-not-found-panel{position:relative;overflow:hidden;padding:34px;border:1px solid #dfd4ed;border-radius:22px;background:rgba(255,255,255,.84);box-shadow:0 25px 60px rgba(62,36,100,.11)}.path-not-found-panel::before{position:absolute;width:280px;height:280px;right:-175px;top:-140px;border:1px solid rgba(124,58,237,.14);border-radius:50%;content:""}.path-not-found-panel-header{position:relative;display:flex;align-items:center;justify-content:space-between;gap:15px}.path-not-found-panel-header span{color:#8f79a2;font-size:9px;font-weight:800;letter-spacing:.13em;text-transform:uppercase;font-family:"Manrope",Arial,sans-serif}.path-not-found-panel-header strong{display:inline-flex;align-items:center;gap:6px;color:#299267;font-size:9px;font-weight:800;font-family:"Manrope",Arial,sans-serif}.path-not-found-panel-header strong i{width:6px;height:6px;border-radius:50%;background:#42bd8a}.path-not-found-panel h2{position:relative;max-width:340px;margin:55px 0 10px;color:#493358;font-size:27px;font-weight:800;font-family:"Manrope",Arial,sans-serif;line-height:1.08;letter-spacing:-.05em}.path-not-found-panel>p{position:relative;max-width:330px;margin:0;color:#82768a;font-size:11px;line-height:1.65;font-family:"Manrope",Arial,sans-serif}.path-not-found-actions{position:relative;display:flex;flex-wrap:wrap;gap:10px;margin-top:26px}.path-not-found-actions button{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:43px;padding:0 15px;border-radius:9px;font-size:10px;font-weight:800;font-family:"DM Sans",Arial,sans-serif;cursor:pointer;transition:all .2s ease}.path-not-found-primary{border:1px solid #7134d6;background:#7c3aed;color:#fff;box-shadow:0 9px 17px rgba(124,58,237,.2)}.path-not-found-primary:hover{background:#6b2fd6;box-shadow:0 12px 20px rgba(124,58,237,.3)}.path-not-found-secondary{border:1px solid #e3dcec;background:#fff;color:#74657f;font-family:"DM Sans",Arial,sans-serif}.path-not-found-secondary:hover{background:#faf9ff;border-color:#dfd4ed}.path-not-found-actions button:active{transform:scale(.97)}.path-not-found-divider{height:1px;margin:27px 0 20px;background:#eee8f4}.path-not-found-tip{display:flex;align-items:flex-start;gap:9px;color:#a095a8;font-size:9px;line-height:1.55;font-family:"Manrope",Arial,sans-serif}.path-not-found-tip svg{flex:0 0 auto;margin-top:1px;color:#a48bcf}
