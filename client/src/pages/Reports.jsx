...
const PATH_REPORTS_CSS = `
  ...
  .path-report-tabs button { position:relative; padding:0 0 9px !important; color:#8d8297 !important; font-family:'DM Sans',sans-serif !important; font-size:12px !important; font-weight:800 !important; }
  ...
  .path-report-card-head p { color:#46384f !important; font-family:'Manrope',sans-serif !important; font-size:14px !important; letter-spacing:-.025em; }
  .path-report-card-head p + p { margin-top:3px !important; color:#9b91a3 !important; font-family:'DM Sans',sans-serif !important; font-size:11px !important; }
  ...
  .path-kpi-card p + p { color:#9e95a5 !important; font-family:'DM Sans',sans-serif !important; font-size:12px !important; letter-spacing:0 !important; }
  .path-filter-label { color:#9b91a3 !important; font-family:'DM Sans',sans-serif !important; font-size:11px !important; font-weight:800 !important; letter-spacing:.08em; text-transform:uppercase; }
  .path-filter-select { height:38px; border-color:#e4dced !important; border-radius:8px !important; color:#645970 !important; font-family:'DM Sans',sans-serif !important; font-size:12px !important; font-weight:700 !important; }
  .path-export-buttons button { border-radius:8px !important; font-family:'DM Sans',sans-serif !important; font-size:12px !important; }
  .path-reports-content table thead tr { background:#faf8fd !important; border-bottom-color:#eeeaf3 !important; }
  .path-reports-content table th { color:#a098a6 !important; font-family:'DM Sans',sans-serif !important; font-size:11px !important; letter-spacing:.08em !important; }
  .path-reports-content table td { color:#62536b; font-family:'DM Sans',sans-serif; }
  @media (max-width:760px) { .path-reports-content { padding:20px 15px 32px !important; }.path-reports-hero { padding:22px 18px !important; }.path-reports-filter { overflow-x:auto; }.path-report-tabs { gap:18px !important; }.path-report-tabs button { font-size:12px !important; }.path-report-card-head { align-items:flex-start !important; }.path-export-buttons { width:100%; }.path-export-buttons button { flex:1; justify-content:center; } }
`;
...
const PATH_REPORTS_EXACT_CSS = `
  ...
  .path-kpi-card > div:first-child > span { font-family:'DM Sans',sans-serif !important; font-size:11px !important; font-weight:800 !important; letter-spacing:.1em !important; text-transform:uppercase !important; }
  ...
  .path-reports-content .recharts-text { fill:#a097a7 !important; font-family:'DM Sans',sans-serif !important; font-size:12px !important; }
  .path-reports-content .recharts-legend-item-text { color:#82758b !important; font-family:'DM Sans',sans-serif !important; font-size:12px !important; }
  .path-reports-content .recharts-tooltip-wrapper { font-family:'DM Sans',sans-serif; font-size:12px; }
...
const PATH_TRANSACTION_REGISTER_CSS = `
  ...
  .path-delay-register { overflow:hidden; border:1px solid #e6e0eb; border-radius:10px 10px 18px 10px; background:#fff; box-shadow:0 7px 20px rgba(67,44,89,.035); }.path-delay-register > header { display:flex; align-items:flex-start; justify-content:space-between; gap:16px; padding:18px 18px 15px; border-bottom:1px solid #eeeaf3; }.path-delay-register > header > div:first-child > span { color:#9b91a1; font-family:'DM Sans',sans-serif; font-size:11px; font-weight:800; letter-spacing:.11em; text-transform:uppercase; }.path-delay-register h2 { margin:7px 0 4px; color:#403448; font-family:'Manrope',sans-serif; font-size:16px; letter-spacing:-.035em; }.path-delay-register p { margin:0; color:#9a90a2; font-family:'DM Sans',sans-serif; font-size:12px; }.path-delay-header-actions { display:flex; align-items:flex-start; gap:9px; }.path-delay-header-actions > aside { display:flex; min-width:68px; align-items:flex-end; flex-direction:column; padding:7px 9px; border-radius:8px; background:#fff4e7; }.path-delay-header-actions > aside strong { color:#bd7020; font-family:'Manrope',sans-serif; font-size:17px; }.path-delay-header-actions > aside small { color:#a47c54; font-family:'DM Sans',sans-serif; font-size:11px; white-space:nowrap; }.path-delay-table-wrap { overflow-x:auto; }.path-delay-table { display:grid; grid-template-columns:minmax(100px,.75fr) minmax(220px,1.7fr) minmax(180px,1.45fr) minmax(120px,.9fr) minmax(155px,1.15fr) minmax(90px,.65fr); gap:14px; align-items:center; min-width:930px; }.path-delay-head { min-height:34px; padding:0 18px; color:#a098a6; font-family:'DM Sans',sans-serif; font-size:11px; font-weight:800; letter-spacing:.08em; text-transform:uppercase; }.path-delay-row { min-height:58px; padding:0 18px; border-top:1px solid #f0edf4; }.path-delay-row > strong { color:#6740a4; font-family:'DM Sans',sans-serif; font-size:12px; font-weight:800; }.path-delay-title { display:flex; min-width:0; flex-direction:column; gap:4px; }.path-delay-title b { overflow:hidden; color:#493950; font-family:'Manrope',sans-serif; font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.path-delay-title small { color:#9b91a2; font-family:'DM Sans',sans-serif; font-size:11px; }.path-delay-faculty { display:flex; min-width:0; align-items:center; gap:8px; overflow:hidden; color:#5e5068; font-family:'DM Sans',sans-serif; font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.path-delay-status { justify-self:start; padding:6px 8px; border-radius:7px; background:#f2eff6; color:#665a70; font-family:'DM Sans',sans-serif; font-size:11px; font-weight:800; }.path-delay-status.delayed { background:#fff5df; color:#b67829; }.path-delay-status.overdue { background:#fff0ef; color:#c33e43; }.path-delay-stage { overflow:hidden; color:#74677d; font-family:'DM Sans',sans-serif; font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.path-delay-days { display:flex; align-items:center; gap:7px; color:#bd7020; font-family:'Manrope',sans-serif; font-size:12px; font-weight:800; }.path-delay-days i { width:7px; height:7px; border:1px solid currentColor; border-radius:50%; }.path-delay-days.overdue { color:#c9343b; }.path-delay-days.overdue i { background:#c9343b; box-shadow:0 0 0 3px #ffe1e1; }.path-delay-empty { display:grid; min-height:105px; place-items:center; margin:0; color:#9b91a2; font-family:'DM Sans',sans-serif; font-size:12px; text-align:center; }.path-delay-register > footer { display:flex; align-items:center; justify-content:space-between; gap:12px; padding:11px 18px; border-top:1px solid #f0edf4; color:#a097a7; font-family:'DM Sans',sans-serif; font-size:11px; }.path-delay-pagination { display:flex; align-items:center; gap:5px; }.path-delay-pagination button { display:grid; width:27px; height:27px; place-items:center; border:1px solid #e6dfef; border-radius:7px; background:#fff; color:#796b84; cursor:pointer; font-family:'DM Sans',sans-serif; font-size:12px; font-weight:800; }.path-delay-pagination button svg { width:13px; height:13px; }.path-delay-pagination button.active { border-color:#7c3aed; background:#7c3aed; color:#fff; }.path-delay-pagination button:disabled { cursor:not-allowed; opacity:.42; }
    ...
    <div className="path-report-card" style={{ background: "#fff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 14, overflow: "hidden", boxShadow: "0 1px 4px rgba(91,33,182,0.05)", display: "flex", flexDirection: "column" }}>
      <div className="path-report-card-head" style={{ padding: "13px 18px", borderBottom: "1px solid rgba(0,0,0,0.07)", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0, flexWrap: "wrap", gap: 8 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          ...
          <div>
            <p style={{ fontSize: 14, fontWeight: 700, color: "#111827", lineHeight: 1.2 }}>{title}</p>
...
function StatusBadge({ s }) {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", fontSize: 13, fontWeight: 600, padding: "4px 10px", borderRadius: 6, background: cfg.bg, color: cfg.color, whiteSpace: "nowrap" }}>
      {s}
    </span>
  );
}
...
function SeverityBadge({ level }) {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 13, fontWeight: 600, padding: "4px 10px", borderRadius: 6, background: cfg.bg, color: cfg.color, whiteSpace: "nowrap" }}>
...
function Pill({ text, color, bg }) {
  return (
    <span style={{ display: "inline-flex", alignItems: "center", fontSize: 13, fontWeight: 600, padding: "4px 10px", borderRadius: 6, background: bg, color, whiteSpace: "nowrap" }}>
      {text}
    </span>
  );
}
...
function Avatar({ name, size = 28, pictureUrl }) {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: size, height: size, borderRadius: "50%", background: cfg.bg, color: cfg.color, fontSize: size * 0.38, fontWeight: 700, flexShrink: 0 }}>
      {initials(name)}
    </span>
  );
}
...
const TH_STYLE = { padding: "10px 16px", fontSize: 12, fontWeight: 600, color: "#9ca3af", textTransform: "uppercase", letterSpacing: 0.5 };
const TD_STYLE = { padding: "10px 16px", fontSize: 13 };
...
function FilterSelect({ label, value, onChange, options }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
      <label className="path-filter-label" style={{ fontSize: 12, fontWeight: 600, color: "#6b7280" }}>{label}</label>
      <select
        className="path-filter-select"
        value={value}
        onChange={onChange}
        style={{ fontSize: 13, padding: "7px 10px", borderRadius: 8, border: "1px solid #e5e7eb", background: "#fff", color: "#111827", cursor: "pointer", minWidth: 140 }}
      >
  ...
  return (
    <div className="path-kpi-card" style={{ background: "#fff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 14, padding: "14px 16px", boxShadow: "0 1px 4px rgba(91,33,182,0.05)" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        ...
        {delta && (
          <span style={{ display: "flex", alignItems: "center", gap: 2, fontSize: 12, fontWeight: 700, color: up ? "#059669" : "#dc2626" }}>
...
function PathBottleneckWorkspace({ items, bottlenecks, alerts, onOpenAlerts, onExport, formatId }) {
  const active = items.filter((item) => !item.done);
  const priority = active.filter((item) => item.overdue || item.status === "Delayed" || item.days >= 5).sort((a, b) => b.days - a.days).slice(0, 5);
  const longestWait = active.length ? Math.max(...active.map((item) => item.days || 0)) : 0;
  const pressure = active.length ? Math.round((priority.length / active.length) * 100) : 0;
  const maxWaiting = Math.max(1, ...bottlenecks.map((item) => item.waiting));
  const lead = bottlenecks[0];
  const leadShare = lead && active.length ? Math.round((lead.waiting / active.length) * 100) : 0;
  const tone = (severity) => severity === "Critical" ? "critical" : severity === "High" ? "high" : severity === "Medium" ? "medium" : "healthy";
  const target = (severity) => severity === "Critical" || severity === "High" ? 2 : severity === "Medium" ? 3 : 4;
  return <div className="path-bottleneck-workspace">
    <div className="path-bn-signals">
      <article className="path-bn-signal critical"><AlertTriangle /><div><span>At risk now</span><strong>{String(priority.length).padStart(2, "0")}</strong><small>records past target</small></div></article>
      <article className="path-bn-signal amber"><Clock /><div><span>Longest wait</span><strong>{longestWait ? `${longestWait}d` : "—"}</strong><small>in the current filter</small></div></article>
      <article className="path-bn-signal violet"><TrendingUp /><div><span>Queue pressure</span><strong>{pressure ? `${pressure}%` : "—"}</strong><small>of active workflow</small></div></article>
    </div>
    <div className="path-bn-main-grid">
      <section className="path-bn-panel path-bn-pressure"><header><div><span>Workflow pressure</span><h2>Workflow pressure map</h2><p>Open queues compared with their comfortable operating target.</p></div><button onClick={() => onOpenAlerts()} aria-label="Open alerts"><ChevronRight /></button></header><div className="path-bn-stage-list">{bottlenecks.map((item) => <div className="path-bn-stage" key={item.stage}><div><strong>{item.label}</strong><em className={tone(item.severity)}>{item.severity === "Critical" || item.severity === "High" ? "Over target" : "Within target"}</em></div><section><i><b className={tone(item.severity)} style={{ width: `${Math.max(4, (item.waiting / maxWaiting) * 100)}%` }} /><u style={{ left: `${Math.min(90, (target(item.severity) / maxWaiting) * 100)}%` }} /></i></section><footer><span>{item.waiting} waiting</span><small>target {target(item.severity)} · {item.avgWait}d avg</small></footer></div>)}{!bottlenecks.length && <p className="path-chart-empty">No workflow bottlenecks match these filters.</p>}</div></section>
...
export default function Reports() {
  ...
  return (
    <div className="path-reports-shell" style={{ display: "flex", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#111", background: "#f4f4f8" }}>
        ...
        <div className="path-reports-main" style={{ minHeight: "calc(100vh - 56px)", background: "#f5f4fb", overflowY: "auto" }}>
          <div className="path-reports-content" style={{ padding: "20px 28px", display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {(itemsLoading || facultyLoading || delayedLoading) && (
              <div style={{ fontSize: 13, color: "#7c3aed", background: "#f5f3ff", border: "1px solid #ddd6fe", borderRadius: 8, padding: "8px 14px" }}>
                Loading live report data…
              </div>
            )}
            {auditUnavailable && activeTab === "Audit Trail" && (
              <div style={{ fontSize: 13, color: "#9a3412", background: "#ffedd5", border: "1px solid #fed7aa", borderRadius: 8, padding: "8px 14px" }}>
            ...
            <div className="path-overview-chart-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1.2fr", gap: 16 }}>
              ...
              <SectionCard
                ...
                action={OVERVIEW_TREND_GROWTH !== null && (
                  <span style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 13, fontWeight: 700, color: OVERVIEW_TREND_GROWTH >= 0 ? "#059669" : "#dc2626", background: OVERVIEW_TREND_GROWTH >= 0 ? "#d1fae5" : "#fee2e2", padding: "3px 8px", borderRadius: 6 }}>
              ...
              <SectionCard title="Faculty Workload Snapshot" subtitle="Top faculty by assigned transaction volume" icon={Users} noPad
                footer={
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <span style={{ fontSize: 13, color: "#9ca3af" }}>Showing {FACULTY_SNAPSHOT.length} of {FACULTY_WORKLOAD.length} faculty</span>
                    <button
                      onClick={() => setActiveTab("Faculty Workload")}
                      style={{ display: "flex", alignItems: "center", gap: 5, padding: "6px 12px", borderRadius: 7, background: "#f5f3ff", color: "#7c3aed", border: "1px solid #ddd6fe", fontSize: 13, fontWeight: 700, cursor: "pointer" }}
                    >
                      ...
                      <tr key={f.name} style={{ borderBottom: i < FACULTY_SNAPSHOT.length - 1 ? "1px solid rgba(0,0,0,0.05)" : "none" }}>
                        ...
                        <td style={{ ...TD_STYLE, textAlign: "center" }}>
                          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, width: 100 }}>
                            ...
                            <span style={{ fontSize: 13, fontWeight: 700, color: "#111827" }}>{f.rate}%</span>
                          </div>
                        </td>
                      </tr>
                    ))}
              ...
              <SectionCard title="Bottleneck Snapshot" subtitle="Slowest workflow stages right now" icon={AlertTriangle}
                footer={
                  <button
                    ...
                    style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 5, width: "100%", padding: "7px 12px", borderRadius: 7, background: "#f5f3ff", color: "#7c3aed", border: "1px solid #ddd6fe", fontSize: 13, fontWeight: 700, cursor: "pointer" }}
                  >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {BOTTLENECK_SNAPSHOT.map(b => (
                    <div key={b.stage} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderRadius: 10, background: "#f8f8fb", border: "1px solid rgba(0,0,0,0.05)" }}>
                      <div>
                        <p style={{ fontSize: 13, fontWeight: 700, color: "#111827" }}>{b.stage}</p>
                        <p style={{ fontSize: 13, color: "#6b7280", marginTop: 2 }}>{b.waiting} waiting · {b.avgWait}d avg wait</p>
                      </div>
                      <SeverityBadge level={b.severity} />
                    </div>
                  ))}
                  {BOTTLENECK_SNAPSHOT.length === 0 && (
                    <p style={{ fontSize: 13, color: "#9ca3af", textAlign: "center", padding: "20px 0" }}>No active bottlenecks — everything is moving smoothly.</p>
                  )}
                </div>
              </SectionCard>
            </div>
            ...
            <div>
              <p style={{ fontSize: 14, fontWeight: 700, color: "#111827", marginBottom: 10 }}>Processing Performance</p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
                <SectionCard title="Fastest Processing Time" icon={TrendingUp}>
                  <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between" }}>
                    ...
                    <span style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 12, fontWeight: 700, color: "#059669", background: "#d1fae5", padding: "3px 8px", borderRadius: 6 }}>
                      <TrendingUp style={{ width: 10, height: 10 }} /> Best
                    </span>
                  </div>
                  <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>Best-case turnaround recorded</p>
                </SectionCard>
                <SectionCard title="Average Processing Time" icon={Gauge}>
                  <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between" }}>
                    ...
                    <span style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 12, fontWeight: 700, color: "#7c3aed", background: "#ede9fe", padding: "3px 8px", borderRadius: 6 }}>
                      <Activity style={{ width: 10, height: 10 }} /> Typical
                    </span>
                  </div>
                  <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>Across all document types</p>
                </SectionCard>
                <SectionCard title="Slowest Processing Time" icon={Clock}>
                  <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between" }}>
                    ...
                    <span style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 12, fontWeight: 700, color: "#dc2626", background: "#fee2e2", padding: "3px 8px", borderRadius: 6 }}>
                      <TrendingDown style={{ width: 10, height: 10 }} /> Watch
                    </span>
                  </div>
                  <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>Worst-case turnaround recorded</p>
                </SectionCard>
              </div>
            </div>
            ...
            <SectionCard title="Recent Activity Feed" subtitle="Latest submissions, approvals, rejections, and workflow updates" icon={ListTodo} noPad
              footer={
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <span style={{ fontSize: 13, color: "#9ca3af" }}>Showing {RECENT_ACTIVITY.length} of {AUDIT_TRAIL.length} log entries</span>
                  <button
                ...
                {RECENT_ACTIVITY.map((a, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "12px 18px", borderBottom: i < RECENT_ACTIVITY.length - 1 ? "1px solid rgba(0,0,0,0.05)" : "none", flexWrap: "wrap" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
                      ...
                      <span style={{ fontFamily: "monospace", fontSize: 13, color: "#374151" }}>{a.transaction}</span>
                    </div>
                    <span style={{ fontFamily: "monospace", fontSize: 13, color: "#9ca3af", whiteSpace: "nowrap" }}>{a.date}</span>
                  </div>
                ))}
                {RECENT_ACTIVITY.length === 0 && (
                  <p style={{ fontSize: 13, color: "#9ca3af", textAlign: "center", padding: "24px 0" }}>No recent activity to show yet.</p>
                )}
              </div>
            </SectionCard>
              </>
            ...
            <SectionCard title="Bottleneck & Alerts" subtitle="Items requiring immediate attention" icon={Shield} noPad>
              {BOTTLENECK_ALERTS.length === 0 ? (
                <p style={{ fontSize: 13, color: "#9ca3af", textAlign: "center", padding: "24px 18px" }}>No active alerts — everything is moving smoothly.</p>
              ) : (
                <>
                        ...
                        >
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                              <p style={{ fontSize: 14, fontWeight: 700, color: "#111827" }}>{a.title}</p>
                              {cfg.showPill && (
                                <span style={{ display: "inline-flex", alignItems: "center", fontSize: 12.5, fontWeight: 700, padding: "2px 8px", borderRadius: 5, background: "#dc2626", color: "#fff", letterSpacing: 0.3 }}>
                                  CRITICAL
                                </span>
                              )}
                            </div>
                            <p style={{ fontSize: 13.5, color: "#4b5563", marginTop: 3, lineHeight: 1.4 }}>{a.message}</p>
                          </div>
                        </div>
                      );
                    })}
                  ...
                  {BOTTLENECK_ALERTS.length > 5 && (
                    <div style={{ borderTop: "1px solid rgba(0,0,0,0.07)", padding: "10px 18px", textAlign: "center" }}>
                      <button
                        ...
                        style={{ background: "none", border: "none", color: "#dc2626", fontSize: 13.5, fontWeight: 700, letterSpacing: 0.3, cursor: "pointer" }}
                      >
                      ...
                      return (
                        <div key={b.stage} style={{ opacity: isEmpty ? 0.55 : 1 }}>
                          <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 10, marginBottom: 6 }}>
                            <p style={{ fontSize: 13, fontWeight: 700, color: "#111827" }}>{b.label}</p>
                            <p style={{ fontSize: 13, color: "#6b7280", whiteSpace: "nowrap", flexShrink: 0 }}>
                  ...
                  <tbody>
                    {RR_ALL.slice(0, 12).map((r, i, arr) => (
                      <tr key={r.id} style={{ borderBottom: i < arr.length - 1 ? "1px solid rgba(0,0,0,0.05)" : "none" }}>
                        <td style={{ ...TD_STYLE, fontFamily: "monospace", fontWeight: 700, color: "#7c3aed", fontSize: 13, whiteSpace: "nowrap" }}>{r.id}</td>
                        ...
                        <td style={TD_STYLE}>
                          <button
                            ...
                            style={{ display: "flex", alignItems: "center", gap: 4, padding: "5px 10px", borderRadius: 7, background: "#f5f3ff", color: "#7c3aed", border: "1px solid #ddd6fe", fontSize: 12.5, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" }}
                          >
                ...
                <tbody>
                  {AUDIT_TRAIL.slice(0, AUDIT_PREVIEW_LIMIT).map((a, i, arr) => (
                    <tr key={i} style={{ borderBottom: i < arr.length - 1 ? "1px solid rgba(0,0,0,0.05)" : "none" }}>
                      <td style={{ ...TD_STYLE, fontFamily: "monospace", color: "#6b7280", whiteSpace: "nowrap", fontSize: 13 }}>{a.date}</td>
                      ...
                      <td style={{ ...TD_STYLE, fontFamily: "monospace", color: "#374151", fontSize: 13 }}>{a.transaction}</td>
            ...
            {/* ── Quick Report Center ── */}
            <div>
              <p style={{ fontSize: 14, fontWeight: 700, color: "#111827", marginBottom: 10 }}>Quick Report Center</p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
                {QUICK_REPORTS.map(r => (
                  <div key={r.title} style={{ background: "#fff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 14, padding: 16, boxShadow: "0 1px 4px rgba(91,33,182,0.05)", display: "flex", flexDirection: "column", gap: 10 }}>
                    ...
                    <div>
                      <p style={{ fontSize: 13, fontWeight: 700, color: "#111827", lineHeight: 1.3 }}>{r.title}</p>
                      <p style={{ fontSize: 12.5, color: "#6b7280", marginTop: 3, lineHeight: 1.4 }}>{r.desc}</p>
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: "auto" }}>
                      <button
                        onClick={() => handleExport(r.title, "View")}
                        style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 5, padding: "6px 10px", borderRadius: 7, background: "#f5f3ff", color: "#7c3aed", border: "1px solid #ddd6fe", fontSize: 12, fontWeight: 700, cursor: "pointer" }}
                      >
                      ...
                      <div style={{ display: "flex", gap: 6 }}>
                        <button
                          ...
                          style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 4, padding: "6px 8px", borderRadius: 7, background: "#fff", color: "#374151", border: "1px solid #e5e7eb", fontSize: 12.5, fontWeight: 700, cursor: "pointer" }}
                        >
      ...
      {/* ── Export toast ── */}
      {exportToast && (
        <div style={{ position: "fixed", bottom: 24, left: "50%", transform: "translateX(-50%)", background: "#111827", color: "#fff", padding: "10px 18px", borderRadius: 10, fontSize: 13, fontWeight: 600, boxShadow: "0 8px 24px rgba(0,0,0,0.25)", zIndex: 2000, display: "flex", alignItems: "center", gap: 8 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "16px 22px", borderBottom: "1px solid rgba(0,0,0,0.07)", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
              <div>
                <p style={{ fontSize: 16, fontWeight: 800, color: "#111827" }}>All Alerts</p>
                <p style={{ fontSize: 13.5, color: "#6b7280" }}>{BOTTLENECK_ALERTS.length} items requiring immediate attention</p>
              </div>
              <button
                onClick={() => { setAlertsModalOpen(false); setAlertsTierFilter("all"); setAlertsSearch(""); }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "12px 22px", borderBottom: "1px solid rgba(0,0,0,0.07)", flexShrink: 0, flexWrap: "wrap" }}>
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    background: t.bg, color: t.color, fontSize: 13.5, fontWeight: 700, cursor: "pointer",
              ...
              <div style={{ position: "relative", marginLeft: "auto", flex: "1 1 160px", minWidth: 140 }}>
                ...
                <input
                  ...
                  style={{ width: "100%", boxSizing: "border-box", fontSize: 13.5, padding: "6px 10px 6px 28px", borderRadius: 8, border: "1px solid rgba(0,0,0,0.1)", outline: "none" }}
                />
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, padding: "14px 22px", maxHeight: "70vh", overflowY: "auto" }}>
              {FILTERED_ALERTS.length === 0 && (
                <p style={{ fontSize: 13, color: "#9ca3af", textAlign: "center", padding: "24px 0" }}>No alerts match this filter.</p>
              )}
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "16px 22px", borderBottom: "1px solid rgba(0,0,0,0.07)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <p style={{ fontSize: 12, fontWeight: 700, color: "#9ca3af", textTransform: "uppercase", letterSpacing: 0.5 }}>Transaction Detail</p>
                <p style={{ fontSize: 16, fontWeight: 800, color: "#111827", fontFamily: "monospace" }}>{rrSelected.id}</p>
              </div>
              <button
                onClick={() => setRrSelected(null)}
            ...
            <div style={{ padding: "18px 22px", display: "flex", flexDirection: "column", gap: 18, maxHeight: "70vh", overflowY: "auto" }}>
              ...
              <div>
                <p style={{ fontSize: 13, fontWeight: 700, color: "#7c3aed", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8 }}>Transaction Information</p>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  ...
                  <div>
                    <p style={{ fontSize: 12, color: "#9ca3af" }}>Current Workflow Stage</p>
                    <p style={{ fontSize: 14, fontWeight: 600, color: "#111827" }}>{rrSelected.stage}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <p style={{ fontSize: 13, fontWeight: 700, color: "#7c3aed", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8 }}>Return / Rejection Reason</p>
                <div style={{ background: "#fef2f2", border: "1px solid #fecaca", borderRadius: 10, padding: "10px 14px" }}>
                  ...
                  <p style={{ fontSize: 13, color: "#374151", marginTop: 8 }}>{rrSelected.reasonRaw || "No specific reason text was recorded for this transaction."}</p>
                </div>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 7, marginTop: 10 }}>
                  ...
                  <div>
                    <p style={{ fontSize: 12, color: "#9ca3af" }}>Reviewer Remarks</p>
                    <p style={{ fontSize: 13, color: "#374151" }}>{rrSelected.reviewerRemarks || "No additional remarks left by the reviewer."}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <p style={{ fontSize: 13, fontWeight: 700, color: "#7c3aed", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8 }}>Supporting Documents</p>
                {rrSelected.attachments && rrSelected.attachments.length > 0 ? (
                  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    {rrSelected.attachments.map((a, idx) => (
                      <div key={idx} style={{ display: "flex", alignItems: "center", gap: 7, fontSize: 13, color: "#374151" }}>
                  ...
                  <p style={{ fontSize: 13, color: "#9ca3af" }}>No supporting documents on record.</p>
                )}
              </div>

              {/* Complete Workflow History */}
              <div>
                <p style={{ fontSize: 13, fontWeight: 700, color: "#7c3aed", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8 }}>Complete Workflow History</p>
                      ...
                      <div key={idx} style={{ display: "flex", gap: 10 }}>
                        ...
                        <div style={{ paddingBottom: 6 }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                            ...
                            <span style={{ fontSize: 12.5, color: "#9ca3af" }}>{h.date}</span>
                          </div>
                          <p style={{ fontSize: 13.5, color: "#6b7280", marginTop: 3 }}>{h.user} — {h.remarks}</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div style={{ padding: "14px 22px", borderTop: "1px solid rgba(0,0,0,0.07)", display: "flex", justifyContent: "flex-end", gap: 8 }}>
              <button
                onClick={() => setRrSelected(null)}
                style={{ padding: "8px 16px", borderRadius: 8, background: "#f3f4f6", color: "#374151", border: "none", fontSize: 13, fontWeight: 700, cursor: "pointer" }}
              >
                Close
              </button>
