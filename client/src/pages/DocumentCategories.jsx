...
.path-cat-live,.path-cat-kicker{font-size:12px!important;font-weight:700!important;letter-spacing:.12em!important}.path-cat-hero h1{font-size:31px!important;font-weight:700!important;letter-spacing:-.045em!important}.path-cat-hero p{font-size:14px!important;line-height:1.4!important}.path-cat-primary{font-size:13px!important;font-weight:800!important}.path-cat-metric>span:not(.path-cat-metric-icon){font-size:12px!important;font-weight:400!important}.path-cat-metric strong{font-size:25px!important;font-weight:800!important}.path-cat-metric small{font-size:12px!important}.path-cat-library h2,.path-cat-detail h2{font-size:17px!important;font-weight:800!important}.path-cat-library-heading b{font-size:12px!important;font-weight:800!important}.path-cat-search input{font-size:12px!important}.path-cat-list-item strong{font-size:12px!important;font-weight:700!important}.path-cat-list-item small,.path-cat-list-state{font-size:12px!important}.path-cat-detail-header p{font-size:12px!important;line-height:1.45!important}.path-cat-code{font-size:12px!important;font-weight:800!important;letter-spacing:.04em!important}.path-cat-ghost,.path-cat-inline-action,.path-cat-inline-danger{font-size:12px!important;font-weight:700!important}.path-cat-detail-stats span{font-size:12px!important;font-weight:800!important;letter-spacing:.04em!important}.path-cat-detail-stats strong{font-size:18px!important;font-weight:800!important}.path-cat-section-heading strong{font-size:13px!important;font-weight:700!important}.path-cat-field-chips>span{font-size:13px!important;font-weight:700!important}.path-cat-empty-fields{font-size:12px!important}.path-cat-connected strong{font-size:12px!important;font-weight:700!important}.path-cat-connected p{font-size:12px!important;line-height:1.4!important}.path-cat-modal h2{font-size:25px!important;font-weight:800!important;letter-spacing:-.04em!important}.path-cat-modal-header p{font-size:13px!important}.path-cat-editor-grid label>span,.path-cat-editor-wide>span,.path-cat-editor-grid legend{font-size:13px!important;font-weight:700!important}.path-cat-editor-grid input,.path-cat-editor-wide textarea,.path-cat-field-row input,.path-cat-field-row select,.path-cat-choice-row input{font-size:13px!important}.path-cat-editor-grid small{font-size:12px!important}.path-cat-segmented button{font-size:13px!important;font-weight:700!important}.path-cat-order{font-size:12px!important;font-weight:800!important}.path-cat-required{font-size:12px!important}.path-cat-choice-header{font-size:12px!important}.path-cat-select-mode,.path-cat-choice-add{font-size:12px!important;font-weight:800!important}.path-cat-document-note strong{font-size:12px!important}.path-cat-document-note p{font-size:12px!important;line-height:1.4!important}.path-cat-error{font-size:12px!important}
@media(max-width:640px){.path-cat-hero h1{font-size:27px!important}.path-cat-metric strong{font-size:21px!important}.path-cat-modal h2{font-size:21px!important}}
`;

const PATH_CATEGORY_PAGINATION_CSS = `
.path-cat-library{display:flex;flex-direction:column}.path-cat-list{flex:1}.path-cat-pagination{display:flex;align-items:center;justify-content:space-between;gap:8px;margin:10px 13px 13px;padding-top:10px;border-top:1px solid #eeeaf3;color:#9b92a4;font:12px 'DM Sans',sans-serif}.path-cat-pagination>div{display:flex;align-items:center;gap:4px}.path-cat-pagination button{display:grid;width:24px;height:24px;place-items:center;border:1px solid #e5dff0;border-radius:6px;background:#fff;color:#847a91;font:700 12px 'DM Sans',sans-serif;cursor:pointer}.path-cat-pagination button:hover:not(:disabled){border-color:#a78bfa;background:#f7f4ff;color:#6d35b9}.path-cat-pagination button.active{border-color:#7c3aed;background:#7c3aed;color:#fff;box-shadow:0 4px 9px rgba(124,58,237,.16)}.path-cat-pagination button:disabled{cursor:not-allowed;opacity:.42}@media(max-width:640px){.path-cat-pagination{margin:10px 12px 12px}.path-cat-pagination button{width:23px;height:23px}}
`;

const PATH_CATEGORY_CSS = `
@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Manrope:wght@500;600;700;800&display=swap');
.path-cat-app{display:flex;min-height:100vh;background:#f8f7ff;color:#2d2840;font-family:'DM Sans',sans-serif;font-size:15px}.path-cat-main{min-width:0;flex:1;display:flex;flex-direction:column;background:#f8f7ff}.path-cat-content{min-height:calc(100vh - 56px);padding:32px;overflow:auto;background:radial-gradient(circle at 94% 0,rgba(196,181,253,.22),transparent 28rem),#f8f7ff}.path-cat-hero{display:flex;align-items:center;justify-content:space-between;gap:24px;min-height:148px;margin:8px 0 25px;padding:29px 24px;border:1px solid #e6ddf5;border-left:2px solid #c4b5fd;border-radius:12px;background:linear-gradient(112deg,#fcfaff,#f5efff);box-shadow:0 12px 30px rgba(57,36,93,.04)}.path-cat-live,.path-cat-kicker{display:block;color:#8e8499;font-size:12px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.path-cat-live{margin-bottom:11px}.path-cat-live i{display:inline-block;width:6px;height:6px;margin-right:8px;border-radius:50%;background:#8b5cf6;box-shadow:0 0 0 4px #eee8ff}.path-cat-hero h1,.path-cat-detail h2,.path-cat-library h2,.path-cat-modal h2{margin:0;color:#2c2537;font-family:'Manrope',sans-serif;letter-spacing:-.045em}.path-cat-hero h1{font-size:31px;font-weight:700;line-height:1.12}.path-cat-hero p{margin:9px 0 0;color:#83778b;font-size:14px;line-height:1.4}.path-cat-primary{display:inline-flex;align-items:center;justify-content:center;gap:7px;border:0;border-radius:10px;padding:11px 16px;background:#7c3aed;color:#fff;font:700 14px 'DM Sans',sans-serif;box-shadow:0 8px 20px rgba(124,58,237,.22);cursor:pointer;transition:transform .16s ease,background .16s ease}.path-cat-primary:hover{background:#6d28d9;transform:translateY(-1px)}.path-cat-primary:active{transform:scale(.97)}.path-cat-primary:disabled{cursor:not-allowed;background:#c4b5fd;box-shadow:none}.path-cat-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-bottom:20px}.path-cat-metric,.path-cat-library,.path-cat-detail{border:1px solid #e6e1ee;background:rgba(255,255,255,.9);box-shadow:0 10px 30px rgba(75,52,105,.045)}.path-cat-metric{position:relative;min-height:123px;padding:18px;border-radius:14px;overflow:hidden}.path-cat-metric:after{position:absolute;right:0;bottom:0;width:62px;height:3px;background:#c4b5fd;content:''}.path-cat-metric-icon{display:grid;width:31px;height:31px;margin-bottom:13px;border-radius:9px;place-items:center;background:#f0ebff;color:#7c3aed}.path-cat-metric>span:not(.path-cat-metric-icon){display:block;color:#827b91;font-size:13px;font-weight:700;letter-spacing:.06em;text-transform:uppercase}.path-cat-metric strong{display:block;margin-top:4px;font-family:'Manrope',sans-serif;font-size:25px;letter-spacing:-.04em}.path-cat-metric small{display:block;margin-top:4px;color:#9b95a7;font-size:13px}.path-cat-layout{display:grid;grid-template-columns:minmax(260px,.82fr) minmax(0,1.8fr);gap:19px}.path-cat-library,.path-cat-detail{min-height:535px;border-radius:15px}.path-cat-library{overflow:hidden}.path-cat-library-heading{display:flex;align-items:flex-start;justify-content:space-between;padding:19px 19px 14px;border-bottom:1px solid #eeeaf3}.path-cat-library h2{margin-top:4px;font-size:19px}.path-cat-library-heading b{display:grid;min-width:28px;height:28px;border-radius:9px;place-items:center;background:#f0ebff;color:#7c3aed;font-size:13px}.path-cat-search{display:flex;align-items:center;gap:8px;margin:13px;border:1px solid #e6e0ee;border-radius:9px;padding:9px 10px;background:#faf9fd;color:#9189a2}.path-cat-search input{min-width:0;flex:1;border:0;outline:0;background:transparent;color:#393348;font:14px 'DM Sans',sans-serif}.path-cat-list{padding:0 7px 10px}.path-cat-list-item{display:grid;width:100%;grid-template-columns:31px minmax(0,1fr) 16px;align-items:center;gap:9px;border:0;border-radius:10px;padding:10px;background:transparent;color:#8b8498;text-align:left;cursor:pointer;transition:background .16s,color .16s}.path-cat-list-item:hover{background:#faf8ff;color:#6d5a8c}.path-cat-list-item.active{background:linear-gradient(90deg,#ede9fe,#f7f4ff);color:#6d28d9}.path-cat-list-item.active .path-cat-list-icon{background:#7c3aed;color:#fff}.path-cat-list-icon{display:grid;width:29px;height:29px;border-radius:8px;place-items:center;background:#f0ecf8;color:#8b5cf6}.path-cat-list-item strong{display:block;overflow:hidden;color:#40394e;font-size:14px;text-overflow:ellipsis;white-space:nowrap}.path-cat-list-item small{display:block;margin-top:3px;overflow:hidden;color:#938b9f;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.path-cat-list-state{padding:30px 16px;color:#8d859b;font-size:13px;text-align:center}.path-cat-detail{padding:25px}.path-cat-detail-header{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.path-cat-detail h2{margin-top:6px;font-size:24px;line-height:1.2}.path-cat-detail-header p{max-width:610px;margin:8px 0;color:#777186;font-size:14px;line-height:1.55}.path-cat-code{color:#7f778d;font-size:13px;font-weight:600}.path-cat-code em{font-style:normal}.path-cat-code em.active{color:#059669}.path-cat-code em.inactive{color:#8a8394}.path-cat-code em.archived{color:#d97706}.path-cat-ghost,.path-cat-inline-action,.path-cat-inline-danger{display:inline-flex;align-items:center;justify-content:center;gap:6px;border:1px solid #ded7e8;border-radius:8px;padding:8px 11px;background:#fff;color:#6746a5;font:700 13px 'DM Sans',sans-serif;white-space:nowrap;cursor:pointer;transition:background .16s,border .16s}.path-cat-ghost:hover,.path-cat-inline-action:hover{border-color:#c4b5fd;background:#f7f4ff}.path-cat-detail-stats{display:grid;grid-template-columns:repeat(3,1fr);margin:24px 0;border:1px solid #eeeaf3;border-radius:11px;overflow:hidden}.path-cat-detail-stats>div{padding:14px 16px;border-right:1px solid #eeeaf3}.path-cat-detail-stats>div:last-child{border-right:0}.path-cat-detail-stats span{display:block;color:#91899b;font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase}.path-cat-detail-stats strong{display:block;margin-top:5px;color:#40384d;font-family:'Manrope',sans-serif;font-size:17px}.path-cat-preview-fields{padding:17px;border:1px solid #ece7f2;border-radius:12px;background:#fcfbfe}.path-cat-section-heading{display:flex;align-items:center;justify-content:space-between;gap:16px}.path-cat-section-heading strong{display:block;margin-top:4px;color:#494153;font-size:14px}.path-cat-field-chips{display:flex;flex-wrap:wrap;gap:7px;margin-top:15px}.path-cat-field-chips>span{display:inline-flex;align-items:center;gap:5px;border:1px solid #ddd5f2;border-radius:20px;padding:6px 9px;background:#f5f2fe;color:#6347a5;font-size:13px;font-weight:600}.path-cat-empty-fields{margin-top:14px;border:1px dashed #ded8e6;border-radius:9px;padding:15px;background:#fff;color:#898193;font-size:13px;text-align:center}.path-cat-connected{display:flex;gap:10px;margin-top:18px;border-left:3px solid #a78bfa;border-radius:7px;padding:11px 13px;background:#f7f4ff}.path-cat-connected svg{margin-top:2px;flex:none;color:#7c3aed}.path-cat-connected strong{color:#514165;font-size:13px}.path-cat-connected p{margin:4px 0 0;color:#827a8f;font-size:13px;line-height:1.45}.path-cat-detail-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px}.path-cat-inline-danger{border-color:#fde1e1;color:#b91c1c}.path-cat-inline-danger:hover{background:#fff6f6}.path-cat-detail-empty{display:grid;min-height:480px;place-content:center;justify-items:center;color:#91899e;text-align:center}.path-cat-detail-empty svg{margin-bottom:10px;color:#a78bfa}.path-cat-detail-empty strong{color:#645b70}.path-cat-detail-empty p{margin:4px 0;font-size:13px}.path-cat-error{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:16px;border:1px solid #fecaca;border-radius:10px;padding:10px 12px;background:#fff6f6;color:#b91c1c;font-size:13px}.path-cat-error button{border:0;background:transparent;color:inherit;cursor:pointer}.path-cat-retry{border:1px solid #f0b9b9!important;border-radius:6px!important;padding:5px 8px!important;background:#fff!important;font-size:13px!important;font-weight:700}.path-cat-modal-backdrop{position:fixed;z-index:2000;inset:0;display:flex;align-items:center;justify-content:center;padding:25px;background:rgba(46,34,64,.38);backdrop-filter:blur(5px)}.path-cat-modal{display:flex;width:min(900px,100%);max-height:calc(100vh - 50px);flex-direction:column;overflow:hidden;border:1px solid #e2ddec;border-radius:16px;background:#fff;box-shadow:0 26px 70px rgba(42,26,62,.25)}.path-cat-modal-header{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;padding:21px 24px 17px;border-bottom:1px solid #eeeaf3}.path-cat-modal h2{margin-top:5px;font-size:23px}.path-cat-modal-header p{margin:5px 0 0;color:#827a8e;font-size:14px}.path-cat-icon-btn{display:inline-grid;width:30px;height:30px;flex:none;border:0;border-radius:8px;place-items:center;background:transparent;color:#90889a;cursor:pointer}.path-cat-icon-btn:hover{background:#f3f0f8;color:#5c486f}.path-cat-modal-body{overflow:auto;padding:21px 24px 24px}.path-cat-editor-grid{display:grid;grid-template-columns:1fr 1fr;gap:17px;margin-bottom:17px}.path-cat-editor-grid label,.path-cat-editor-wide{display:block}.path-cat-editor-grid label>span,.path-cat-editor-wide>span,.path-cat-editor-grid legend{display:block;margin-bottom:6px;color:#594f62;font-size:13px;font-weight:700}.path-cat-editor-grid b{color:#7c3aed}.path-cat-editor-grid input,.path-cat-editor-wide textarea,.path-cat-field-row input,.path-cat-field-row select,.path-cat-choice-row input{box-sizing:border-box;width:100%;border:1px solid #dfd9e8;border-radius:8px;padding:9px 10px;outline:0;background:#fff;color:#393243;font:14px 'DM Sans',sans-serif;transition:border .16s,box-shadow .16s}.path-cat-editor-grid input:focus,.path-cat-editor-wide textarea:focus,.path-cat-field-row input:focus,.path-cat-field-row select:focus,.path-cat-choice-row input:focus{border-color:#a78bfa;box-shadow:0 0 0 3px rgba(167,139,250,.18)}.path-cat-editor-grid input:disabled{background:#f6f4f8;color:#91899b}.path-cat-editor-grid small{display:block;margin-top:5px;color:#9991a2;font-size:12px}.path-cat-editor-wide textarea{min-height:76px;resize:vertical}.path-cat-editor-grid fieldset{min-width:0;border:0;padding:0;margin:0}.path-cat-segmented{display:flex;gap:4px;border:1px solid #dfd9e8;border-radius:9px;padding:3px;background:#faf9fc}.path-cat-segmented button{min-width:0;flex:1;border:0;border-radius:6px;padding:7px 8px;background:transparent;color:#847b90;font:700 13px 'DM Sans',sans-serif;cursor:pointer}.path-cat-segmented button.active{background:#7c3aed;color:#fff;box-shadow:0 2px 5px rgba(124,58,237,.2)}.path-cat-form-fields{margin-top:20px;border-top:1px solid #eeeaf3;padding-top:18px}.path-cat-builder-list{display:flex;flex-direction:column;gap:9px;margin-top:13px}.path-cat-builder-item{border:1px solid #e8e3ee;border-radius:10px;padding:9px;background:#fbfaff}.path-cat-field-row{display:grid;grid-template-columns:30px minmax(0,1fr) 154px 92px 30px;align-items:center;gap:8px}.path-cat-order{display:grid;width:25px;height:25px;border-radius:7px;place-items:center;background:#ece8f3;color:#786e86;font-size:13px;font-weight:700}.path-cat-required{display:flex;align-items:center;gap:6px;white-space:nowrap;color:#71687b;font-size:13px;font-weight:700}.path-cat-required input{accent-color:#7c3aed}.path-cat-delete-field{color:#b5acbe}.path-cat-choice-editor{margin:9px 0 0 33px;border:1px solid #ded6f1;border-radius:8px;padding:10px;background:#f7f4ff}.path-cat-choice-header{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:7px;color:#6c50a6;font-size:12px;font-weight:800;letter-spacing:.04em;text-transform:uppercase}.path-cat-select-mode,.path-cat-choice-add{display:inline-flex;align-items:center;gap:4px;border:1px solid #cfc3eb;border-radius:6px;padding:4px 7px;background:#fff;color:#6d4dab;font:700 12px 'DM Sans',sans-serif;cursor:pointer}.path-cat-choice-row{display:flex;align-items:center;gap:5px;margin-top:5px}.path-cat-choice-row input{padding:6px 8px;font-size:13px}.path-cat-choice-add{margin-top:7px}.path-cat-document-note{display:flex;gap:11px;margin-top:20px;border:1px solid #dfd5f1;border-radius:10px;padding:14px;background:#f7f4ff}.path-cat-document-note svg{flex:none;color:#7c3aed}.path-cat-document-note strong{color:#59446e;font-size:13px}.path-cat-document-note p{margin:4px 0 0;color:#82788c;font-size:13px;line-height:1.45}.path-cat-modal-actions{display:flex;justify-content:flex-end;gap:9px;border-top:1px solid #eeeaf3;padding:14px 24px;background:rgba(255,255,255,.96)}
...
@media(max-width:640px){.path-cat-content{padding:18px 14px}.path-cat-hero{align-items:flex-start;flex-direction:column;min-height:0;margin-top:3px;padding:22px 18px}.path-cat-hero h1{font-size:27px}.path-cat-hero p{font-size:14px}.path-cat-primary{width:100%}.path-cat-metrics{grid-template-columns:1fr 1fr;gap:9px}.path-cat-metric{min-height:107px;padding:14px}.path-cat-metric strong{font-size:21px}.path-cat-metric small{font-size:12px}.path-cat-list{grid-template-columns:1fr}.path-cat-detail{padding:18px}.path-cat-detail-header{flex-direction:column}.path-cat-ghost{width:100%}.path-cat-detail-stats{grid-template-columns:1fr}.path-cat-detail-stats>div{border-right:0;border-bottom:1px solid #eeeaf3}.path-cat-detail-stats>div:last-child{border-bottom:0}.path-cat-section-heading{align-items:flex-start;flex-direction:column}.path-cat-section-heading .path-cat-ghost{width:auto}.path-cat-detail-actions{flex-wrap:wrap;justify-content:stretch}.path-cat-detail-actions button{flex:1}.path-cat-modal-backdrop{align-items:flex-start;padding:10px}.path-cat-modal{max-height:calc(100vh - 20px);border-radius:13px}.path-cat-modal-header,.path-cat-modal-body{padding-right:16px;padding-left:16px}.path-cat-modal h2{font-size:21px}.path-cat-editor-grid{grid-template-columns:1fr;gap:13px}.path-cat-field-row{grid-template-columns:27px minmax(0,1fr) 28px}.path-cat-field-row select{grid-column:2/4}.path-cat-required{grid-column:1/3}.path-cat-delete-field{grid-column:3;grid-row:1}.path-cat-choice-editor{margin-left:0}.path-cat-modal-actions{padding:12px 16px}.path-cat-modal-actions .path-cat-ghost,.path-cat-modal-actions .path-cat-primary{width:auto;flex:1}}
`;