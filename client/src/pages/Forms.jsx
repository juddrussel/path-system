...
export default function Forms() {
  ...
  useEffect(() => {
    if (isProgramChair && activeTab === "allSubmissions") fetchAllForms();
  ...
  return (
    <div
      className={`path-forms-shell ${isProgramChair && activeTab === "review" ? "path-forms-queue-active" : ""} ${!isProgramChair && activeTab === "submit" ? "path-forms-start-active" : ""} ${!isProgramChair && activeTab === "history" ? "path-forms-register-active" : ""} ${isProgramChair && activeTab === "allSubmissions" ? "path-forms-allsubs-active" : ""}`}
      style={{
        display: "flex",
        minHeight: "100vh",
        fontFamily: "'DM Sans', sans-serif",
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* ── ALL SUBMISSIONS (Program Chair only) ── */}
