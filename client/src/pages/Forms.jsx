...
export default function Forms() {
  ...
  return (
    <div
      className={`path-forms-shell ${isProgramChair && activeTab === "review" ? "path-forms-queue-active" : ""} ${!isProgramChair && activeTab === "submit" ? "path-forms-start-active" : ""} ${!isProgramChair && activeTab === "history" ? "path-forms-register-active" : ""}`}
      style={{
        display: "flex",
        minHeight: "100vh",
        fontFamily: "'DM Sans', sans-serif",
