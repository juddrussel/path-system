...
export default function DocumentReview() {
  ...
  // ── Live clock — ticks every second so elapsed% updates in real time ───────
    ...
    deadline && submitted
      ? Math.max(
          ...
          Math.min(
            100,
            Math.round(
              ((nowMs - new Date(submitted).getTime()) /
                Math.max(
                  1,
              ...
              <Panel className="doc-sla">
                ...
                <div className="doc-progress">
                  <i
                    ...
                    style={{
                      width: `${elapsed}%`,
                      background: elapsed >= 100
                        ? "linear-gradient(90deg,#fca5a5,#ef4444)"
                        : elapsed >= 75
                          ? "linear-gradient(90deg,#fdba74,#f97316)"
                          : "linear-gradient(90deg,#c3a8f7,#7c3aed)",
                    }}
                  />
                </div>
