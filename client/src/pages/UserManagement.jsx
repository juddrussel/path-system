...
const editUserModalCss = `
  ...
  .path-edit-kicker { display: flex; align-items: center; color: #9b8eaa; font-size: 12px; font-weight: 800; letter-spacing: .13em; text-transform: uppercase; }
  ...
  .path-edit-title { margin: 8px 0 4px; font-size: 20px; font-weight: 800; letter-spacing: -.02em; line-height: 1.1; color: #1f1729; }
  .path-edit-copy { margin: 0; color: #82768a; font-size: 13px; line-height: 1.5; }
  .path-edit-close { width: 30px; height: 30px; border: 0; border-radius: 8px; background: transparent; color: #9b8eaa; font-size: 19px; line-height: 1; cursor: pointer; }
  ...
  .path-edit-avatar { display: grid; width: 34px; height: 34px; flex-shrink: 0; place-items: center; border-radius: 10px; font-size: 13px; font-weight: 900; }
  ...
  .path-edit-person-name { color: #4c3c56; font-size: 14px; font-weight: 800; }
  .path-edit-person-email { margin-top: 3px; color: #9b8eaa; font-size: 13px; }
  .path-edit-status { color: #39745d; font-size: 12px; font-weight: 800; white-space: nowrap; }
  ...
  .path-edit-label { color: #51405e; font-size: 13px; font-weight: 800; }
  .path-edit-required { margin-left: 7px; color: #7c3aed; font-size: 12px; letter-spacing: .08em; text-transform: uppercase; }
  .path-edit-input, .path-edit-select { width: 100%; min-height: 40px; border: 1px solid #ded6e5; border-radius: 9px; padding: 0 12px; outline: 0; background: #fff; color: #3f3448; font-size: 14px; font-weight: 500; }
  ...
  .path-edit-notice { margin: 0 24px 16px; border: 1px solid #f3c9c2; border-radius: 8px; padding: 9px 10px; background: #fdf4f3; color: #b42318; font-size: 13px; line-height: 1.4; }
  ...
  .path-edit-audit { color: #9b8eaa; font-size: 12px; }
  .path-edit-actions { display: flex; gap: 8px; }
  .path-edit-button { min-height: 38px; border-radius: 8px; padding: 0 14px; font-size: 13px; font-weight: 800; cursor: pointer; }
...
const userDetailModalCss = `
  ...
  .path-user-details-kicker { display: flex; align-items: center; color: #9b8eaa; font-size: 12px; font-weight: 800; letter-spacing: .13em; text-transform: uppercase; }
  ...
  .path-user-details-title { margin: 8px 0 4px; color: #1f1729; font-size: 20px; font-weight: 800; letter-spacing: -.02em; line-height: 1.1; }
  .path-user-details-description { margin: 0; color: #82768a; font-size: 13px; line-height: 1.5; }
  .path-user-details-close { display: grid; width: 30px; height: 30px; flex: 0 0 auto; place-items: center; border: 0; border-radius: 8px; background: transparent; color: #9b8eaa; font-size: 19px; cursor: pointer; }
  ...
  .path-user-details-avatar { display: grid; width: 34px; height: 34px; flex: 0 0 auto; place-items: center; border-radius: 10px; font-size: 13px; font-weight: 900; overflow: hidden; }
  ...
  .path-user-details-identity-copy strong { color: #4c3c56; font-size: 14px; font-weight: 800; }
  .path-user-details-identity-copy span { margin-top: 3px; color: #9b8eaa; font-size: 13px; }
  .path-user-details-identity-copy small { margin-top: 4px; color: #b0a5b7; font-size: 12px; }
  .path-user-details-status { color: #39745d; font-size: 12px; font-weight: 800; white-space: nowrap; }
  ...
  .path-user-details-card-label { display: block; overflow: hidden; color: #9b90a5; font-size: 12px; font-weight: 800; letter-spacing: .08em; text-overflow: ellipsis; text-transform: uppercase; white-space: nowrap; }
  .path-user-details-card-value { display: block; overflow: hidden; margin-top: 7px; color: #51405e; font-size: 13px; font-weight: 800; text-overflow: ellipsis; white-space: nowrap; }
  ...
  .path-user-details-activity-value { display: block; overflow: hidden; margin-top: 6px; color: #51405e; font-size: 14px; font-weight: 800; text-overflow: ellipsis; white-space: nowrap; }
  .path-user-details-activity-note { display: block; overflow: hidden; margin-top: 5px; color: #94889e; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
  ...
  .path-user-details-footer-note { max-width: 220px; color: #9b8eaa; font-size: 12px; line-height: 1.45; }
  .path-user-details-actions { display: flex; align-items: center; gap: 8px; }
  .path-user-details-button { min-height: 36px; border-radius: 8px; padding: 0 14px; font-size: 13px; font-weight: 800; cursor: pointer; }
  ...
  return (
    ...
    >
      <style>{`
        ...
        .path-um-kicker { display:flex; align-items:center; gap:8px; margin-bottom:11px; color:#8e8499; font-size:12px; font-weight:700; letter-spacing:.12em; text-transform:uppercase; }
        .path-um-kicker::before { width:6px; height:6px; border-radius:50%; background:#8b5cf6; content:''; box-shadow:0 0 0 4px #eee8ff; }
        .path-um-hero h1 { margin:0; color:#2c2537; font-family:'Manrope',sans-serif; font-size:31px; font-weight:700; letter-spacing:-.045em; line-height:1.12; }
        .path-um-hero p { max-width:650px; margin:9px 0 0; color:#83778b; font-size:14px; line-height:1.4; }
        ...
        .path-um-insight strong { display:block; color:#5b4f64; font-family:'Manrope',sans-serif; font-size:12px; }
        .path-um-insight small { display:block; margin-top:2px; color:#9a90a2; font-size:11px; }
        .path-um-primary { display:inline-flex; min-height:40px; align-items:center; justify-content:center; gap:8px; border-radius:9px; padding:0 15px; background:#7c3aed; color:#fff; font-size:12px; font-weight:800; box-shadow:0 7px 17px rgba(124,58,237,.2); }
        ...
        .path-um-stat-card span { color:#a198a7; font-size:12px; font-weight:800; letter-spacing:.08em; text-transform:uppercase; }
        ...
        .path-um-stat-card small { display:block; margin-top:5px; color:#9c92a3; font-size:12px; }
        ...
        .path-um-access-card-head { display:flex; align-items:flex-start; justify-content:space-between; gap:14px; }.path-um-access-card-head h3 { margin:3px 0 0; color:#4d3f55; font-family:'Manrope',sans-serif; font-size:16px; letter-spacing:-.035em; }.path-um-access-card-head > svg { color:#a398aa; }.path-um-access-card > p { margin:17px 0 11px; padding:12px 13px; border-radius:8px; background:#faf8ff; color:#8c8197; font-size:12px; line-height:1.55; }.path-um-role-summary { display:flex; align-items:center; gap:10px; padding:13px 0; border-bottom:1px solid #f0edf4; }.path-um-role-summary > div { display:flex; min-width:0; flex:1; flex-direction:column; gap:4px; }.path-um-role-summary strong { color:#65586d; font-family:'Manrope',sans-serif; font-size:12px; }.path-um-role-summary div span { color:#9d92a4; font-size:11px; }.path-um-role-summary b { color:#5d4d66; font-family:'Manrope',sans-serif; font-size:16px; }.path-um-role-icon { display:grid; width:28px; height:28px; place-items:center; border-radius:8px; }.path-um-role-icon.violet { background:#eee7fd; color:#7044c5; }.path-um-role-icon.blue { background:#e8f1fc; color:#5e86ae; }.path-um-role-icon.amber { background:#fcf0d6; color:#a27a1d; }.path-um-role-action { margin-top:16px; color:#7543c7; font-size:12px; font-weight:800; }
        .path-um-directory { background:#fff; }.path-um-directory-head { display:flex; align-items:flex-end; justify-content:space-between; gap:18px; padding:20px 22px 16px; border-bottom:1px solid #f1edf5; background:linear-gradient(180deg,#fff,#fdfbff); }.path-um-directory-head h2 { margin:3px 0 0; color:#40344b; font-family:'Manrope',sans-serif; font-size:19px; letter-spacing:-.04em; }.path-um-directory-head h2 span { display:inline-grid; min-width:19px; height:17px; margin-left:5px; place-items:center; border-radius:5px; background:#f0e9fc; color:#7543c7; font-family:'DM Sans',sans-serif; font-size:11px; vertical-align:middle; }.path-um-directory-head p { margin:5px 0 0; color:#a098a7; font-size:12px; }.path-um-directory-controls { display:flex; align-items:center; gap:10px; }.path-um-directory-search { display:flex; width:174px; align-items:center; gap:7px; padding:0 3px; color:#6e6475; }.path-um-directory-search input { width:100%; border:0; outline:0; background:transparent; color:#5c5164; font-size:12px; }.path-um-directory-search input::placeholder { color:#aaa0ad; }.path-um-directory-controls select { min-width:94px; padding:4px 22px 4px 3px; border:0; outline:0; background:#fff; color:#64596c; font-size:12px; cursor:pointer; }
        .path-um-list-head, .path-um-person-row { display:grid; grid-template-columns:minmax(230px,1.55fr) minmax(145px,.9fr) minmax(125px,.75fr) 82px 110px; gap:14px; align-items:center; }
        .path-um-list-head { padding:10px 22px; border-bottom:1px solid #f0edf4; background:#fbf9fd; color:#8f8597; font-size:11px; font-weight:900; letter-spacing:.08em; text-transform:uppercase; }
