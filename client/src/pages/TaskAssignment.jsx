  ...
  return (
    <div className="path-assignment-shell">
      <style>{`
        ...
        .path-assignment-shell{display:flex;min-height:100vh;background:#f8f7ff;color:#463750;font-family:'DM Sans',sans-serif}.path-assignment-shell *{box-sizing:border-box}.path-assignment-shell button,.path-assignment-shell input,.path-assignment-shell select,.path-assignment-shell textarea{font:inherit}.path-assignment-main{display:flex;min-width:0;flex:1;flex-direction:column;min-height:100vh}.path-assignment-content{width:100%;margin:0 auto;padding:28px 44px 42px}@media(min-width:1100px){.path-assignment-content{padding-left:clamp(48px,5vw,84px);padding-right:clamp(48px,5vw,84px)}}.path-assignment-search{display:flex;align-items:center;gap:8px;width:min(420px,100%);padding:0 11px;border:1px solid #e2dbe9;border-radius:8px;background:#fff;color:#93879d}.path-assignment-search svg{width:13px;height:13px}.path-assignment-search input{width:100%;height:34px;border:0;outline:0;background:transparent;color:#53425f;font-size:12px}.path-assignment-hero{display:flex;justify-content:space-between;gap:26px;min-height:148px;padding:29px 24px;border:1px solid #e6ddf5;border-left:2px solid #c4b5fd;border-radius:12px;background:linear-gradient(112deg,#fcfaff,#f5efff);box-shadow:0 12px 30px rgba(57,36,93,.04)}.path-assignment-back{display:inline-flex;align-items:center;gap:6px;margin:0 0 21px;padding:0;border:0;background:none;color:#75548f;font-size:12px;font-weight:700;cursor:pointer}.path-assignment-back svg{width:14px}.path-assignment-eyebrow{display:flex;align-items:center;gap:8px;color:#8e8499;font-size:12px;font-weight:700;letter-spacing:.12em}.path-assignment-eyebrow i{width:6px;height:6px;border-radius:50%;background:#8b5cf6;box-shadow:0 0 0 4px #eee8ff}.path-assignment-hero h1{margin:9px 0 7px;color:#2c2537;font-family:'Manrope',sans-serif;font-size:31px;font-weight:700;letter-spacing:-.045em;line-height:1.12}.path-assignment-hero p{max-width:610px;margin:0;color:#83778b;font-size:14px;line-height:1.4}.path-assignment-ticket{align-self:flex-start;min-width:170px;padding:14px 15px;border:1px solid #ddd0ef;border-radius:11px;background:#fff;text-align:right}.path-assignment-ticket>span{display:block;color:#8870a4;font-size:11px;font-weight:800;letter-spacing:.11em;text-transform:uppercase}.path-assignment-ticket strong{display:block;margin-top:4px;color:#603e84;font-family:'Manrope',sans-serif;font-size:14px;font-weight:800;letter-spacing:-.04em}.path-assignment-ticket small{display:flex;align-items:center;justify-content:flex-end;gap:5px;margin-top:12px;color:#9b8ca4;font-size:11px}.path-assignment-ticket small i{width:5px;height:5px;border-radius:50%;background:#5cb891}.path-assignment-layout{display:grid;grid-template-columns:minmax(0,1.52fr) minmax(285px,.48fr);align-items:start;gap:16px;margin-top:16px}.path-assignment-form,.path-assignment-aside{border:1px solid #e5dfee;border-radius:15px;background:#fff;box-shadow:0 12px 26px rgba(78,49,112,.035)}.path-assignment-stages{display:flex;align-items:center;gap:8px;padding:17px 23px;border-bottom:1px solid #eee8f2;color:#a196a6;font-size:12px;font-weight:800;letter-spacing:.04em;text-transform:uppercase}.path-assignment-stages span{display:flex;align-items:center;gap:5px}.path-assignment-stages span.done{color:#55a27f}.path-assignment-stages span.active{color:#703ccd}.path-assignment-stages i{flex:1;height:1px;background:#e6dff0}.path-assignment-section{padding:22px 23px;border-bottom:1px solid #eee9f3}.path-assignment-section:last-of-type{border:0}.path-assignment-section-head{display:flex;align-items:center;gap:10px;margin-bottom:16px}.path-assignment-section-icon{display:grid;width:28px;height:28px;place-items:center;border-radius:8px;background:#eee8fb;color:#7542c2}.path-assignment-section-icon svg{width:15px}.path-assignment-section-head small{display:block;color:#9b8ca3;font-size:11px;font-weight:800;letter-spacing:.1em;text-transform:uppercase}.path-assignment-section-head h2{margin:3px 0 0;color:#4a3a56;font-family:'Manrope',sans-serif;font-size:17px;font-weight:800;letter-spacing:-.045em}.path-assignment-mode{display:flex;gap:7px;margin-bottom:11px}.path-assignment-mode button{display:inline-flex;align-items:center;gap:7px;padding:8px 10px;border:1px solid #e2dbe9;border-radius:8px;background:#fff;color:#806e8d;font-size:12px;font-weight:700;cursor:pointer}.path-assignment-mode button span{width:7px;height:7px;border:1.5px solid #b9adbf;border-radius:50%}.path-assignment-mode button.active{border-color:#c9b4ef;background:#f9f6ff;color:#6b39be}.path-assignment-mode button.active span{border-color:#7c3aed;box-shadow:inset 0 0 0 2px #fff;background:#7c3aed}.path-assignment-picker{position:relative}.path-assignment-picker-trigger{display:flex;align-items:center;justify-content:space-between;width:100%;height:39px;padding:0 11px;border:1px solid #e0d9e7;border-radius:8px;background:#fff;color:#5e4e6b;font-size:12px;cursor:pointer}.path-assignment-picker-trigger strong{font-size:12px}.path-assignment-picker-menu{position:absolute;z-index:10;top:calc(100% + 5px);left:0;right:0;max-height:240px;overflow:auto;border:1px solid #d6c8e7;border-radius:10px;background:#fff;box-shadow:0 14px 24px rgba(56,31,87,.13)}.path-assignment-picker-all,.path-assignment-picker-option{display:flex;align-items:center;gap:9px;padding:9px 11px;border-bottom:1px solid #f0ebf3;color:#5a4965;font-size:12px;cursor:pointer}.path-assignment-picker-all{position:sticky;top:0;background:#fff;color:#703ccd;font-weight:800}.path-assignment-picker-option:last-child{border-bottom:0}.path-assignment-picker-option small{color:#9b8e9f}.path-assignment-picker-option input,.path-assignment-picker-all input{accent-color:#7c3aed}.path-assignment-avatar{display:grid;width:27px;height:27px;place-items:center;border-radius:8px;background:#eee8fb;color:#7541c1;font-size:11px;font-weight:800}.path-assignment-chips{display:flex;flex-wrap:wrap;gap:6px;margin-top:9px}.path-assignment-chip{display:inline-flex;align-items:center;gap:5px;padding:4px 5px 4px 8px;border-radius:6px;background:#f0eafb;color:#6e49a0;font-size:11px;font-weight:700}.path-assignment-chip button{display:grid;width:15px;height:15px;place-items:center;padding:0;border:0;border-radius:50%;background:#dfd0f6;color:#77539e;cursor:pointer}.path-assignment-chip button svg{width:9px}.path-assignment-role-select,.path-assignment-field select,.path-assignment-field input,.path-assignment-notes textarea{display:block;width:100%;border:1px solid #e0d9e7;border-radius:8px;background:#fff;color:#51405d;outline:0}.path-assignment-role-select,.path-assignment-field select,.path-assignment-field input{height:38px;padding:0 10px;font-size:12px}.path-assignment-field-grid{display:grid;grid-template-columns:minmax(0,1.4fr) minmax(120px,.62fr) minmax(105px,.45fr);gap:9px}.path-assignment-field-grid.title{display:block;margin-bottom:10px}.path-assignment-field{display:block;color:#75647f;font-size:11px;font-weight:800;letter-spacing:.055em;text-transform:uppercase}.path-assignment-notes{display:block;margin-top:12px;color:#75647f;font-size:11px;font-weight:800;letter-spacing:.055em;text-transform:uppercase}.path-assignment-notes textarea{min-height:104px;margin-top:7px;padding:11px;font-size:12px;line-height:1.5;resize:vertical}.path-assignment-role-select:focus,.path-assignment-field select:focus,.path-assignment-field input:focus,.path-assignment-notes textarea:focus{border-color:#a77ee4;box-shadow:0 0 0 3px rgba(124,58,237,.09)}.path-assignment-sla-hint{margin:7px 0 0;color:#8263a6;font-size:11px;line-height:1.45}.path-assignment-priorities{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.path-assignment-priorities button{display:flex;flex-wrap:wrap;align-items:center;gap:6px;padding:10px;border:1px solid #e4dce9;border-radius:9px;background:#fff;color:#705f7b;font-size:12px;font-weight:800;text-align:left;cursor:pointer}.path-assignment-priorities button i{width:6px;height:6px;border-radius:50%;background:#b2a8ba}.path-assignment-priorities button small{display:block;width:100%;color:#9c90a4;font-size:11px;font-weight:500}.path-assignment-priorities button.active.high{border-color:#efb9ad;background:#fff8f6;color:#b25e53}.path-assignment-priorities button.active.high i{background:#df695b}.path-assignment-priorities button.active.medium{border-color:#d7ba55;background:#fffbec;color:#876a16}.path-assignment-priorities button.active.medium i{background:#e8af20}.path-assignment-priorities button.active.low{border-color:#b8e0cf;background:#f4fcf8;color:#438c6b}.path-assignment-priorities button.active.low i{background:#4db487}.path-assignment-sla{display:grid;grid-template-columns:auto 1fr 1fr 1fr;align-items:center;gap:10px;margin-top:12px;padding:12px;border:1px solid #e4d8f3;border-radius:9px;background:#faf7ff;color:#7553a0}.path-assignment-sla svg{width:15px}.path-assignment-sla span{display:block}.path-assignment-sla small{display:block;color:#9b8ea2;font-size:10px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.path-assignment-sla strong{display:block;margin-top:4px;color:#5c456d;font-size:12px;font-weight:800}.path-assignment-dropzone{display:flex;align-items:center;gap:10px;width:100%;margin-top:12px;padding:13px;border:1px dashed #cbb9e6;border-radius:9px;background:#fcfaff;color:#79559d;text-align:left;cursor:pointer}.path-assignment-dropzone.drag{border-color:#7c3aed;background:#f6f0ff}.path-assignment-dropzone svg{width:17px}.path-assignment-dropzone span{flex:1}.path-assignment-dropzone strong,.path-assignment-dropzone small{display:block}.path-assignment-dropzone strong{font-size:12px;font-weight:800}.path-assignment-dropzone small{margin-top:3px;color:#a194aa;font-size:11px}.path-assignment-attachments{display:flex;flex-direction:column;gap:6px;margin-top:9px}.path-assignment-attachment{display:grid;grid-template-columns:28px minmax(0,1fr) auto;align-items:center;gap:8px;padding:8px;border:1px solid #ece6f2;border-radius:8px;background:#fff}.path-assignment-file-kind{display:grid;width:27px;height:27px;place-items:center;border-radius:7px;background:#eee8fb;color:#7049a4;font-size:11px;font-weight:800}.path-assignment-attachment strong,.path-assignment-attachment small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.path-assignment-attachment strong{color:#5c4a68;font-size:12px}.path-assignment-attachment small{margin-top:3px;color:#9a8d9f;font-size:11px}.path-assignment-attachment small.error{color:#be6557}.path-assignment-attachment button{display:grid;width:22px;height:22px;place-items:center;padding:0;border:0;border-radius:50%;background:#f4f1f7;color:#7f6b8b;cursor:pointer}.path-assignment-attachment button svg{width:11px}.path-assignment-actions{display:flex;align-items:center;gap:8px;padding:17px 23px}.path-assignment-actions>div{display:flex;align-items:center;gap:7px;flex:1;color:#93859d;font-size:11px;line-height:1.4}.path-assignment-actions>div svg{width:15px;color:#8052b7}.path-assignment-actions>button{min-height:34px;padding:0 11px;border:1px solid #e1d9e9;border-radius:8px;background:#fff;color:#705e7c;font-size:12px;font-weight:800;cursor:pointer}.path-assignment-actions>button.violet{display:inline-flex;align-items:center;gap:6px;border-color:#7c3aed;background:#7c3aed;color:#fff;box-shadow:0 8px 16px rgba(124,58,237,.16)}.path-assignment-actions>button:disabled{opacity:.65;cursor:not-allowed}.path-assignment-aside{position:sticky;top:20px;overflow:hidden}.path-assignment-aside-hero{padding:21px;background:linear-gradient(145deg,#5720bc,#8c5ce5 63%,#b899ef);color:#fff}.path-assignment-aside-hero>span{display:flex;align-items:center;gap:6px;font-size:11px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;opacity:.82}.path-assignment-aside-hero>span svg{width:15px}.path-assignment-aside-hero h2{margin:12px 0 7px;font-family:'Manrope',sans-serif;font-size:20px;font-weight:800;letter-spacing:-.055em;line-height:1.12}.path-assignment-aside-hero p{margin:0;font-size:12px;line-height:1.5;opacity:.84}.path-assignment-aside-hero>div{display:flex;align-items:baseline;gap:6px;margin-top:19px}.path-assignment-aside-hero>div strong{font-family:'Manrope',sans-serif;font-size:29px;font-weight:800;letter-spacing:-.07em}.path-assignment-aside-hero>div span{font-size:11px;font-weight:700;opacity:.85}.path-assignment-capacity{margin:13px;padding:13px;border:1px solid #e8e1ed;border-radius:10px;background:#fff}.path-assignment-capacity>div:first-child{display:flex;align-items:center;justify-content:space-between;color:#8f8099;font-size:11px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.path-assignment-capacity>div:first-child strong{color:#529275;font-family:'Manrope',sans-serif;font-size:13px}.path-assignment-capacity-bar{height:6px;margin:10px 0 7px;border-radius:999px;background:#eee8f3;overflow:hidden}.path-assignment-capacity-bar i{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#43ab82,#8cdbbb)}.path-assignment-capacity small{color:#9b8e9f;font-size:11px;line-height:1.4}.path-assignment-aside-section{padding:16px 18px;border-top:1px solid #eee8f1}.path-assignment-aside-heading{display:flex;justify-content:space-between;margin-bottom:12px;align-items:center}.path-assignment-aside-heading::before{display:none !important}.path-assignment-aside-heading span{color:#574663;font-family:'Manrope',sans-serif;font-size:12px;font-weight:800;background:none !important;border:none !important;border-radius:0 !important;padding:0 !important}
.path-assignment-aside-heading span::before, .path-assignment-aside-heading span::after{display:none !important}.path-assignment-aside-heading small{color:#998ca0;font-size:11px;font-weight:700}.path-assignment-workload-row{display:grid;grid-template-columns:27px minmax(0,1fr) auto;align-items:center;gap:8px;padding:9px 0;border-top:1px solid #f3eff5}.path-assignment-workload-row>span:nth-child(2){min-width:0}.path-assignment-workload-row strong,.path-assignment-workload-row small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.path-assignment-workload-row strong{color:#594867;font-size:12px;font-weight:800}.path-assignment-workload-row small{margin-top:3px;color:#9a8e9f;font-size:10px}.path-assignment-workload-row em{padding:4px 5px;border-radius:5px;background:#e8f6ef;color:#4d9474;font-size:11px;font-style:normal;font-weight:800}.path-assignment-workload-row em.busy{background:#fff0ec;color:#ba6859}.path-assignment-empty{margin:0;color:#9b8e9f;font-size:12px;line-height:1.5}.path-assignment-quality>div:not(.path-assignment-aside-heading){display:flex;align-items:center;gap:11px;padding:10px 0;color:#71607d;font-size:12px}.path-assignment-quality>div>span{display:grid;width:24px;height:24px;place-items:center;border:2px solid #dfd6e8;border-radius:50%;color:#9c90a1;font-size:13px;font-weight:800;flex-shrink:0}.path-assignment-quality>div>span.complete{border-color:#c8eadb;background:#eaf7f0;color:#4e9a76}.path-assignment-quality>div strong{font-size:12px;font-weight:700}.path-assignment-success{display:flex;align-items:center;gap:7px;margin:14px 0 -2px;padding:10px;border:1px solid #bce7d1;border-radius:8px;background:#f2fcf6;color:#3c8866;font-size:12px;font-weight:700}.path-assignment-success svg{width:14px}.path-assignment-footer{display:flex;justify-content:space-between;gap:12px;margin-top:14px;color:#a195a7;font-size:11px}.path-assignment-footer button{border:0;background:none;color:#7442b9;font-size:11px;font-weight:800;cursor:pointer}@media(max-width:1080px){.path-assignment-content{padding:24px}.path-assignment-layout{grid-template-columns:1fr}.path-assignment-aside{position:static;display:grid;grid-template-columns:1.1fr .9fr .9fr}.path-assignment-aside-hero{grid-row:span 2}.path-assignment-aside-section{border-left:1px solid #eee8f1}.path-assignment-quality{grid-column:2 / 4}}@media(max-width:720px){.path-assignment-content{padding:18px 16px 28px}.path-assignment-hero{flex-direction:column;min-height:0;padding:22px 18px}.path-assignment-hero h1{font-size:27px}.path-assignment-ticket{align-self:stretch;text-align:left}.path-assignment-ticket small{justify-content:flex-start}.path-assignment-field-grid{grid-template-columns:1fr}.path-assignment-aside{display:block}.path-assignment-aside-section{border-left:0}.path-assignment-stages{padding-inline:17px}.path-assignment-section{padding:19px 17px}.path-assignment-actions{flex-wrap:wrap;padding:16px 17px}.path-assignment-actions>div{min-width:100%;margin-bottom:2px}.path-assignment-sla{grid-template-columns:auto 1fr}.path-assignment-sla span:nth-of-type(n+2){grid-column:2}.path-assignment-priorities{grid-template-columns:1fr}.path-assignment-aside-hero{padding:19px}}
      `}</style>
      <style>{`
        .path-assignment-picker-trigger,.path-assignment-picker-trigger>span,.path-assignment-picker-trigger>strong{font-family:'DM Sans',sans-serif !important}.path-assignment-picker-trigger{font-size:12px !important;font-weight:600 !important;letter-spacing:-.01em;line-height:1.2}.path-assignment-picker-trigger>span{font-size:12px !important;font-weight:600 !important;line-height:1.2}.path-assignment-picker-trigger>strong{font-size:13px !important;font-weight:700 !important;line-height:1;color:#806e8d}
        .path-assignment-section:first-of-type .path-assignment-section-head small{font-size:10px!important;line-height:1!important;letter-spacing:.12em}.path-assignment-section:first-of-type .path-assignment-section-head h2{font-size:14px!important;line-height:1.15!important;letter-spacing:-.035em}.path-assignment-section:first-of-type .path-assignment-mode button{min-height:31px!important;padding:0 10px!important;font-size:11px!important;line-height:1!important}.path-assignment-section:first-of-type .path-assignment-role-select{height:34px!important;padding:0 10px!important;font-size:12px!important;line-height:1.1!important}.path-assignment-section:first-of-type .path-assignment-role-select option{font-size:12px!important}
        .path-assignment-section:first-of-type .path-assignment-mode{gap:6px!important;margin-bottom:10px!important}.path-assignment-section:first-of-type .path-assignment-mode button{border-color:#e2dbe9!important;border-radius:7px!important;background:#fff!important;color:#806e8d!important;box-shadow:none!important;transition:border-color .16s ease,background .16s ease,color .16s ease}.path-assignment-section:first-of-type .path-assignment-mode button.active{border-color:#c9b4ef!important;background:#fbf9ff!important;color:#6b39be!important}.path-assignment-section:first-of-type .path-assignment-mode button span{width:7px!important;height:7px!important}.path-assignment-section:first-of-type .path-assignment-picker-trigger{height:39px!important;padding:0 12px!important;border-color:#e0d9e7!important;border-radius:8px!important;background:#fff!important;color:#5e4e6b!important;font-size:12px!important;font-weight:600!important;box-shadow:none!important}.path-assignment-section:first-of-type .path-assignment-picker-trigger>span{font-size:12px!important}.path-assignment-section:first-of-type .path-assignment-picker-trigger>strong{font-size:12px!important}
      `}</style>
