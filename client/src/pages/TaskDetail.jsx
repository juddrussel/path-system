    ...
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "calc(100vh - 60px)", background: "#f8f7ff", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="td-load-card">
          {/* Header ΓÇö mimics the violet task header */}
          ...
          {/* Body ΓÇö mimics the description + meta sections */}
                    ...
                    <section className="td-card">
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", marginBottom: "16px" }}>
                        ...
                        <div style={{
                          ...
                          {allConfirmed ? "Γ£ô All confirmed" : `ΓÅ│ ${collaborators.filter(c => !c.confirmed_at).length} waiting`}
                        </div>
                      </div>
                  ...
                  <section className="td-card" ref={submissionPanelRef}>
                    ...
                    {(task.revision_instruction ||
                      ...
                      <div className="td-return-guidance">
                        <span>ChairΓÇÖs revision instructions</span>
                        <p>
                          {task.revision_instruction ||
                            task.return_instruction ||
                            task.return_reason}
                    ...
                    <label className="td-note-label">
                      ...
                      <textarea
                        ...
                        rows={3}
                        placeholder="Summarize what was completed or flag any exception for reviewΓÇª"
                      />
                    </label>
                    {submissionError && (
                      <p
                    ...
                    {isCollaborative && isFacultyView && (
                      <div style={{ marginTop: "12px", padding: "12px", border: "1px solid #fbbf24", borderRadius: "8px", backgroundColor: "#fffbeb" }}>
                        ...
                        {!hasCurrentUserConfirmed && (
                          ...
                          >
                            {confirmingCollaboration ? "ConfirmingΓÇª" : "Confirm my edits"}
                          </button>
                        )}
                        {hasCurrentUserConfirmed && (
                          <div style={{ fontSize: "12px", color: "#16a34a", fontWeight: "600" }}>
                            Γ£ô You have confirmed
                          </div>
                        )}
                      </div>
                    )}
                    ...
                    >
                      ...
                      {submitting
                        ...
                        : isCollaborative && !allConfirmed
                          ? `Awaiting ${collaborators.filter(c => !c.confirmed_at).length} confirmation(s)ΓÇª`
                          : status.tone === "returned"
              ...
              <aside className="td-side">
                    ...
                    {isFacultyView ? (
                      ...
                      <>
                        ...
                        >
                          ...
                          {deciding ? "SavingΓÇª" : "Approve task"}
                        </button>
                        <button
                          className="td-return"
                          type="button"
                  ...
                  {!isFacultyView && returnOpen && (
                    <form className="td-return-form" onSubmit={returnTask}>
                      ...
                      <textarea
                        ...
                        placeholder="Explain what needs to be corrected before the next submissionΓÇª"
                        autoFocus
                      />
                      {returnError && (
                ...
                <section className="td-side-card">
                  ...
                  <div className="td-readiness">
                    ...
                    >
                      <b>{task.deadline || task.due_date ? "Γ£ô" : ""}</b>{" "}
                      Deadline{" "}
                    ...
                    >
                      <b>{latestSubmission || selectedFile ? "Γ£ô" : ""}</b>{" "}
                      Completed file{" "}
                      {latestSubmission
                        ? "submitted"
                        : selectedFile
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end" }}>
              ...
              >
                {confirmingCollaboration ? "ConfirmingΓÇª" : "Yes, confirm"}
              </button>
            </div>
          </div>
        </div>
