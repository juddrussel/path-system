...
export default function TaskDetail() {
  ...
  const [activeView, setActiveView] = useState(
    location.state?.viewerRole || (isChair ? "chair" : "faculty"),
  );
  ...
  const isFacultyView = activeView === "faculty";
  const taskOwner =
  ...
  return (
    <div className="td-shell">
      <style>{`
        ...
        .td-shell{display:flex;min-height:100vh;background:#f8f7ff;color:#4a3a55;font-family:'DM Sans',sans-serif}.td-shell *{box-sizing:border-box}.td-main{display:flex;min-width:0;flex:1;flex-direction:column}.td-scroll{flex:1;overflow:auto;padding:28px 40px 44px}.td-page{max-width:1320px;margin:0 auto}.td-loading{display:flex;min-height:64vh;flex-direction:column;align-items:center;justify-content:center;gap:9px;color:#8d8098;font-size:12px}.td-loading strong{color:#574362;font:800 20px Manrope,sans-serif}.td-loading button{margin-top:8px;border:0;border-radius:8px;padding:9px 12px;background:#7c3aed;color:#fff;font:800 10px 'DM Sans',sans-serif;cursor:pointer}
        .td-hero{position:relative;overflow:hidden;padding:23px 25px 28px;border:1px solid #e3d9ee;border-radius:17px;background:linear-gradient(123deg,#fff,#fcfaff 52%,#efe7ff);box-shadow:0 18px 42px rgba(77,47,112,.06)}.td-hero:after{position:absolute;right:-62px;bottom:-92px;width:260px;height:260px;border-radius:50%;background:radial-gradient(circle,rgba(124,58,237,.16),transparent 66%);content:''}.td-hero-top,.td-hero-controls,.td-view-toggle{display:flex;align-items:center}.td-hero-top{position:relative;z-index:1;justify-content:space-between;gap:16px}.td-back{display:inline-flex;align-items:center;gap:7px;border:0;background:transparent;color:#76558e;font-size:10px;font-weight:800;cursor:pointer}.td-hero-controls{gap:10px}.td-view-toggle{gap:2px;padding:3px;border:1px solid #e5d9ee;border-radius:8px;background:#fff}.td-view-toggle button{display:inline-flex;align-items:center;gap:5px;border:0;border-radius:5px;padding:6px 8px;background:transparent;color:#8f8199;font-size:8px;font-weight:800;cursor:pointer}.td-view-toggle button.active{background:#efe7fc;color:#6f3eb4}.td-created{display:flex;align-items:center;gap:5px;color:#9b8da5;font-size:8px;font-weight:700}.td-hero-grid{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1fr) 230px;gap:26px;margin-top:30px}.td-kicker{display:flex;align-items:center;gap:8px;color:#9680a8;font-size:8px;font-weight:800;letter-spacing:.1em;text-transform:uppercase}.td-kicker b{border-radius:6px;padding:5px 8px;background:#e9ddff;color:#7041b3;font-size:9px;letter-spacing:.03em}.td-kicker i{width:4px;height:4px;border-radius:50%;background:#a78bfa}.td-hero h1{max-width:690px;margin:10px 0 8px;color:#372541;font:800 34px Manrope,sans-serif;letter-spacing:-.062em;line-height:1.08}.td-hero p{max-width:630px;margin:0;color:#887995;font-size:11px;line-height:1.55}.td-status-card{align-self:end;padding:15px 16px;border:1px solid #e2d6ef;border-radius:12px;background:rgba(255,255,255,.85)}.td-status-card span{display:block;color:#9888a1;font-size:8px;font-weight:800;letter-spacing:.09em;text-transform:uppercase}.td-status-card strong{display:block;margin-top:5px;color:#553d66;font:800 13px Manrope,sans-serif;letter-spacing:-.04em}.td-status-card em{display:flex;align-items:center;gap:5px;margin-top:11px;color:#876f99;font-size:8px;font-style:normal;font-weight:700}.td-dot{width:6px;height:6px;border-radius:50%;background:#e1b347}.td-dot.review{background:#7c3aed}.td-dot.approved{background:#51ab83}.td-dot.returned{background:#dc7365}
              ...
              <div className="td-hero-top">
                ...
                <div className="td-hero-controls">
                  <div
                    ...
                    role="group"
                    aria-label="Task detail perspective"
                  >
                    <button
                      className={activeView === "chair" ? "active" : ""}
                      type="button"
                      onClick={() => setActiveView("chair")}
                    >
                      <Icon name="shield" size={13} /> Chair view
                    </button>
                    <button
                      className={activeView === "faculty" ? "active" : ""}
                      type="button"
                      onClick={() => setActiveView("faculty")}
                    >
                      <Icon name="user" size={13} /> Faculty view
                    </button>
                  </div>
                ...
                <section className="td-card">
                  ...
                  <div className="td-copy">
                    ...
                    <ol>
                      ...
                      <li>
                        Use the submission note to identify exceptions or final
                        checks.
                      </li>
                    </ol>
                  </div>
                ...
                {latestSubmission && (
                  <section className="td-card">
                    ...
                    <div className="td-file-preview">
                      <div className="td-file-preview-head">
                        <span>
