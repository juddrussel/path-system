    ...
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "calc(100vh - 60px)", background: "#f8f7ff", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="td-load-card">
          {/* Header âœ“‚¬â€ mimics the violet task header */}
          ...
          {/* Body âœ“‚¬â€ mimics the description + meta sections */}
          ...
          <div className="td-page">
            ...
            <div className="td-layout">
              <main className="td-main-column">
                      ...
                      {isFacultyView ? (
                        ...
                        <span className="td-deadline-editor">
                          ...
                          <span className="td-deadline-actions">
                            ...
                            >
                              {deadlineSaving ? "Savingâœ“‚¬Â¦" : "Save"}
                            </button>
                          </span>
                          {deadlineError && (
                ...
                {/* âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬âœ“€â‚¬ */}
                    ...
                    <section className="td-card">
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", marginBottom: "16px" }}>
                        ...
                        <div style={{
                          ...
                          {allConfirmed ? "Ã¢Å“â€œ All confirmed" : `Ã¢ÂÂ³ ${collaborators.filter(c => !c.confirmed_at).length} waiting`}
                        </div>
                      </div>
                        ...
                        <section className="td-card" ref={submissionPanelRef}>
                          ...
                          <label className="td-note-label">
                            ...
                            <textarea
                              ...
                              rows={3}
                              placeholder="Summarize what was completed or flag any exception for reviewâœ“‚¬Â¦"
                            />
                          </label>
                          {submissionError && (
                            <p
                          ...
                          {isCollaborative && isFacultyView && (
                            <div style={{ marginTop: "12px", padding: "12px", border: "1px solid #fbbf24", borderRadius: "8px", backgroundColor: "#fffbeb" }}>
                              ...
                              {!hasCurrentUserConfirmed && (
                                ...
                                >
                                  {confirmingCollaboration ? "Confirmingâœ“‚¬Â¦" : "Confirm my edits"}
                                </button>
                              )}
                              {hasCurrentUserConfirmed && (
                          ...
                          >
                            ...
                            {submitting
                              ...
                              : isCollaborative && !allConfirmed
                                ? `Awaiting ${collaborators.filter(c => !c.confirmed_at).length} confirmation(s)âœ“‚¬Â¦`
                                : status.tone === "returned"
              ...
              <aside className="td-side">
                    ...
                    {isFacultyView ? (
                      ...
                      <>
                        ...
                        >
                          ...
                          {deciding ? "Savingâœ“‚¬Â¦" : "Approve task"}
                        </button>
                        <button
                          className="td-return"
                          type="button"
                  ...
                  {!isFacultyView && returnOpen && (
                    <form className="td-return-form" onSubmit={returnTask}>
                      ...
                      <textarea
                        ...
                        placeholder="Explain what needs to be corrected before the next submissionâœ“‚¬Â¦"
                        autoFocus
                      />
                      {returnError && (
                ...
                <section className="td-side-card">
                  ...
                  <div className="td-readiness">
                    ...
                    >
                      <b>{task.deadline || task.due_date ? "Ã¢Å“â€œ" : ""}</b>{" "}
                      Deadline{" "}
                    ...
                    >
                      <b>{latestSubmission || selectedFile ? "Ã¢Å“â€œ" : ""}</b>{" "}
                      Completed file{" "}
                      {latestSubmission
                        ? "submitted"
                        : selectedFile
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end" }}>
              ...
              >
                {confirmingCollaboration ? "Confirmingâœ“‚¬Â¦" : "Yes, confirm"}
              </button>
            </div>
          </div>
        </div>
