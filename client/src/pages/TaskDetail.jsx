...
function FileCard({ file, api, onPreview, label = "Attached file" }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <strong>{name}</strong>
        <small>{formatSize(file.size)} ÃÂ· Open inline preview</small>
      </div>
      <Icon name="preview" />
    </button>
  );
    ...
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "calc(100vh - 60px)", background: "#f8f7ff", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="td-load-card">
          {/* Header âï¿½ï¿½â mimics the violet task header */}
          ...
          {/* Body âï¿½ï¿½â mimics the description + meta sections */}
  ...
  return (
    <div className="td-shell">
      <style>{`
        ...
        .td-shell{display:flex;min-height:100vh;background:linear-gradient(135deg,#fafbff 0%,#f8f7ff 50%,#fdfbff 100%);color:#4a3a55;font-family:'DM Sans',sans-serif}.td-shell *{box-sizing:border-box}.td-main{display:flex;min-width:0;flex:1;flex-direction:column}.td-scroll{flex:1;overflow:auto;padding:32px 40px 48px}@media(min-width:1100px){.td-scroll{padding-left:clamp(48px,5vw,84px);padding-right:clamp(48px,5vw,84px)}}.td-page{max-width:none;margin:0 auto}.td-loading{display:flex;min-height:64vh;flex-direction:column;align-items:center;justify-content:center;gap:10px;color:#9083a0;font-size:13px;font-family:'DM Sans',sans-serif}.td-loading strong{color:#3b2a52;font:800 18px Manrope,sans-serif;margin-top:4px}.td-loading>span{color:#a095ab;font-size:12px}.td-loading button{margin-top:8px;border:0;border-radius:8px;padding:10px 18px;background:linear-gradient(135deg,#7c3aed 0%,#6d28d9 100%);color:#fff;font:800 12px 'DM Sans',sans-serif;cursor:pointer;box-shadow:0 8px 16px rgba(124,58,237,0.25);transition:all 0.2s}.td-loading button:hover{transform:translateY(-2px);box-shadow:0 12px 24px rgba(124,58,237,0.35)}
        .td-hero{position:relative;overflow:hidden;padding:28px 32px 32px;border:1px solid #e0d5ed;border-radius:20px;background:linear-gradient(135deg,#fff 0%,#fcfbff 45%,#f5f0ff 100%);box-shadow:0 16px 48px rgba(77,47,112,.08)}.td-hero:after{position:absolute;right:-72px;bottom:-102px;width:280px;height:280px;border-radius:50%;background:radial-gradient(circle,rgba(124,58,237,.12),transparent 70%);content:''}.td-hero-top,.td-hero-controls{display:flex;align-items:center}.td-hero-top{position:relative;z-index:1;justify-content:space-between;gap:16px}.td-back{display:inline-flex;align-items:center;gap:7px;border:0;background:transparent;color:#7d6594;font-size:12px;font-weight:800;cursor:pointer;transition:all 0.2s;padding:6px 12px;border-radius:8px}.td-back:hover{background:rgba(124,58,237,0.08);color:#6d5384}.td-hero-controls{gap:11px}.td-role-pill{display:inline-flex;align-items:center;gap:6px;border:1.2px solid #ddd0eb;border-radius:9px;padding:8px 11px;background:#fff;color:#725394;font-size:11px;font-weight:800;box-shadow:0 2px 8px rgba(0,0,0,0.04);transition:all 0.2s}.td-role-pill:hover{border-color:#c8b5e0;background:#f9f7ff}.td-created{display:flex;align-items:center;gap:5px;color:#a89faa;font-size:11px;font-weight:700;padding:6px 12px;border-radius:8px;background:rgba(255,255,255,0.5)}.td-hero-grid{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1fr) 250px;gap:32px;margin-top:32px}.td-kicker{display:flex;align-items:center;gap:8px;color:#9a90a8;font-size:11px;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.td-kicker b{border-radius:8px;padding:6px 10px;background:#e8d9ff;color:#6b38b8;font-size:12px;letter-spacing:.04em;font-weight:700}.td-kicker i{width:4px;height:4px;border-radius:50%;background:#a78bfa}.td-hero h1{max-width:690px;margin:12px 0 10px;color:#2d1d3f;font:800 36px Manrope,sans-serif;letter-spacing:-.065em;line-height:1.1}.td-hero p{max-width:630px;margin:0;color:#8b8093;font-size:13px;line-height:1.62}.td-status-card{align-self:end;padding:18px 20px;border:1.2px solid #ddd0e8;border-radius:14px;background:rgba(255,255,255,.95);box-shadow:0 6px 20px rgba(124,58,237,0.06)}.td-status-card span{display:block;color:#a89faa;font-size:11px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;margin-bottom:4px}.td-status-card strong{display:block;color:#3d2a50;font:800 15px Manrope,sans-serif;letter-spacing:-.05em;margin-bottom:10px}.td-status-card em{display:flex;align-items:center;gap:6px;color:#8b7d94;font-size:11px;font-style:normal;font-weight:600}.td-dot{width:8px;height:8px;border-radius:50%;background:#fbbf24;box-shadow:0 0 0 3px rgba(251,191,36,0.15)}.td-dot.review{background:#7c3aed;box-shadow:0 0 0 3px rgba(124,58,237,0.15)}.td-dot.approved{background:#10b981;box-shadow:0 0 0 3px rgba(16,185,129,0.15)}.td-dot.returned{background:#ef4444;box-shadow:0 0 0 3px rgba(239,68,68,0.15)}
        .td-layout{display:grid;grid-template-columns:minmax(0,1.48fr) minmax(290px,.56fr);align-items:start;gap:20px;margin-top:20px}.td-main-column{display:flex;flex-direction:column;gap:20px}.td-card,.td-side-card{border:1px solid #ddd4e8;border-radius:16px;background:#fff;box-shadow:0 8px 24px rgba(73,44,105,.04)}.td-card{padding:26px}.td-section-title{display:flex;align-items:center;gap:12px}.td-icon{display:grid;width:36px;height:36px;place-items:center;border-radius:10px;background:#ede5fa;color:#6d38b8}.td-section-title>div>span,.td-side-label{display:block;color:#a89faa;font-size:11px;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.td-section-title h2{margin:3px 0 0;color:#3d2a50;font:800 18px Manrope,sans-serif;letter-spacing:-.05em}.td-meta-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px 20px;margin-top:21px;padding-top:18px;border-top:1px solid #f0ebf3}.td-meta>span{display:flex;align-items:center;gap:5px;color:#9b8da2;font-size:11px;font-weight:800;letter-spacing:.04em;text-transform:uppercase}.td-meta>strong{display:flex;align-items:center;gap:6px;margin-top:8px;color:#56405f;font-size:12px;line-height:1.35}.td-avatar{display:grid;width:20px;height:20px;place-items:center;border-radius:6px;background:#eee7fb;color:#7545bd;font-size:11px}.td-priority{color:#bd6257}.td-deadline-value{display:flex;align-items:center;gap:7px;flex-wrap:wrap}.td-deadline-value button,.td-deadline-actions button{border:1px solid #dccdea;border-radius:5px;padding:4px 6px;background:#faf8fd;color:#7549a3;font-size:10px;font-weight:800;cursor:pointer}.td-deadline-editor{display:grid;gap:6px;margin-top:5px}.td-deadline-editor input{width:100%;padding:7px;border:1px solid #d9cbe6;border-radius:6px;color:#594668;font-size:11px}.td-deadline-actions{display:flex;gap:6px}.td-deadline-actions button:last-child{border-color:#7c3aed;background:#7c3aed;color:#fff}.td-field-error{margin:0;color:#b55e51;font-size:11px;line-height:1.4}
        .td-copy{padding:17px 0 2px;color:#6a5a73;font-size:12px;line-height:1.65}.td-copy p{margin:0}.td-brief-content{margin:0;white-space:pre-wrap;overflow-wrap:anywhere}.td-copy ol{display:grid;gap:4px;margin:13px 0 0;padding-left:17px}.td-file-card{display:flex;align-items:center;gap:12px;width:100%;margin-top:16px;padding:13px;border:1px solid #ddd4e8;border-radius:11px;background:#f9f8fc;color:#6d4a8e;text-align:left;cursor:pointer;transition:all 0.2s}.td-file-card:hover{border-color:#c8b5e0;background:#f0ebf8;box-shadow:0 4px 12px rgba(124,58,237,0.1)}.td-file-card>span{display:grid;width:31px;height:31px;place-items:center;border-radius:8px;background:#e9ddfb}.td-file-card>div{flex:1;min-width:0}.td-file-card strong,.td-file-card small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.td-file-card strong{font-size:12px;font-weight:800}.td-file-card small{margin-top:3px;color:#9a88a6;font-size:11px}.td-file-card>svg{color:#7e57b2}
        .td-submission-intro{margin:15px 0 0;color:#8d7e98;font-size:12px;line-height:1.55}.td-return-guidance{margin-top:13px;padding:11px;border:1px solid #edd9bb;border-left:3px solid #c58644;border-radius:8px;background:#fff9ef}.td-return-guidance span{display:block;color:#996d37;font-size:11px;font-weight:800;letter-spacing:.07em;text-transform:uppercase}.td-return-guidance p{margin:6px 0 0;color:#70543a;font-size:12px;line-height:1.55}.td-upload-button{display:flex;align-items:center;gap:12px;width:100%;margin-top:16px;padding:13px;border:2px dashed #d9cbe6;border-radius:11px;background:#f9f8fc;color:#6d4a8e;text-align:left;cursor:pointer;transition:all 0.2s}.td-upload-button:hover{border-color:#a78bfa;background:#f0ebf8}.td-upload-button.selected{border-style:solid;border-color:#10b981;background:#f0fdf4;color:#059669}.td-upload-button>span{display:grid;width:31px;height:31px;place-items:center;border-radius:8px;background:#ece2fb}.td-upload-button>div{flex:1;min-width:0}.td-upload-button strong,.td-upload-button small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.td-upload-button strong{font-size:12px;font-weight:800}.td-upload-button small{margin-top:3px;color:#9a8ba6;font-size:11px}.td-note-label{display:block;margin-top:12px;color:#806f8b;font-size:11px;font-weight:800;letter-spacing:.07em;text-transform:uppercase}.td-note-label textarea,.td-composer textarea,.td-return-form textarea{display:block;width:100%;margin-top:8px;padding:12px 14px;border:1px solid #ddd4e8;border-radius:10px;outline:0;resize:vertical;color:#5d4867;font:11px 'DM Sans',sans-serif;line-height:1.6;transition:all 0.2s;background:#fff}.td-note-label textarea:focus,.td-composer textarea:focus,.td-return-form textarea:focus{border-color:#a78bfa;box-shadow:0 0 0 3px rgba(124,58,237,0.08)}.td-submit{display:inline-flex;align-items:center;gap:6px;margin-top:14px;border:0;border-radius:9px;padding:10px 14px;background:linear-gradient(135deg,#7c3aed 0%,#6d28d9 100%);color:#fff;font-size:12px;font-weight:800;cursor:pointer;box-shadow:0 8px 16px rgba(124,58,237,.24);transition:all 0.2s}.td-submit:hover:not(:disabled){transform:translateY(-2px);box-shadow:0 12px 24px rgba(124,58,237,.32)}.td-submit:disabled{opacity:.5;cursor:not-allowed}
        .td-submitted-intro{margin:13px 0 0;color:#8b7d96;font-size:12px;line-height:1.5}.td-note-block{margin-top:15px;padding:14px 16px;border:1px solid #e8dff5;border-left:3px solid #7c3aed;border-radius:10px;background:#fcfaff}.td-note-block span{display:block;color:#8b7d94;font-size:11px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;margin-bottom:6px}.td-note-block p{margin:0;color:#6d5a7d;font-size:12px;line-height:1.65}.td-file-preview{margin-top:14px;border:1px solid #e2d8ea;border-radius:10px;overflow:hidden;background:#faf8fc}.td-file-preview-head{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:9px 11px;border-bottom:1px solid #e7e0ec;background:#fff}.td-file-preview-head>span{display:flex;align-items:center;gap:5px;color:#8a7b94;font-size:11px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.td-file-preview-head div{display:flex;align-items:center;gap:7px;min-width:0}.td-file-preview-head strong{overflow:hidden;color:#594568;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.td-file-preview-head small{color:#9d91a5;font-size:11px;white-space:nowrap}.td-file-preview-frame{display:block;width:100%;height:420px;border:0;background:#f4eefb}.td-file-preview-image{display:block;width:100%;max-height:540px;object-fit:contain;background:#f4eefb}.td-file-preview-fallback{display:flex;min-height:176px;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:22px;background:linear-gradient(135deg,#f4eefb,#fbfaff);color:#84758f;text-align:center}.td-file-preview-fallback strong{color:#60496e;font-size:12px}.td-file-preview-fallback span{max-width:330px;font-size:11px;line-height:1.55}.td-file-preview button{display:block;width:100%;border:0;padding:9px;background:#fff;color:#7650a3;font-size:11px;font-weight:800;cursor:pointer}
          ...
          <div className="td-page">
            ...
            <div className="td-layout">
              <main className="td-main-column">
                      ...
                      {isFacultyView ? (
                        ...
                        <span className="td-deadline-editor">
                          ...
                          <span className="td-deadline-actions">
                            ...
                            >
                              {deadlineSaving ? "Savingâï¿½ï¿½Â¦" : "Save"}
                            </button>
                          </span>
                          {deadlineError && (
                ...
                {/* âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬âï¿½ï¿½â¬ */}
                    ...
                    <section className="td-card">
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", marginBottom: "16px" }}>
                        ...
                        <div style={{
                          ...
                          {allConfirmed ? "Ã¢Åâ All confirmed" : `Ã¢ÂÂ³ ${collaborators.filter(c => !c.confirmed_at).length} waiting`}
                        </div>
                      </div>
                        ...
                        <section className="td-card" ref={submissionPanelRef}>
                          ...
                          <label className="td-note-label">
                            ...
                            <textarea
                              ...
                              rows={3}
                              placeholder="Summarize what was completed or flag any exception for reviewâï¿½ï¿½Â¦"
                            />
                          </label>
                          {submissionError && (
                            <p
                          ...
                          {isCollaborative && isFacultyView && (
                            <div style={{ marginTop: "12px", padding: "12px", border: "1px solid #fbbf24", borderRadius: "8px", backgroundColor: "#fffbeb" }}>
                              ...
                              {!hasCurrentUserConfirmed && (
                                ...
                                >
                                  {confirmingCollaboration ? "Confirmingâï¿½ï¿½Â¦" : "Confirm my edits"}
                                </button>
                              )}
                              {hasCurrentUserConfirmed && (
                                <div style={{ fontSize: "12px", color: "#16a34a", fontWeight: "600" }}>
                                  â You have confirmed
                                </div>
                              )}
                            </div>
                          )}
                          ...
                          >
                            ...
                            {submitting
                              ...
                              : isCollaborative && !allConfirmed
                                ? `Awaiting ${collaborators.filter(c => !c.confirmed_at).length} confirmation(s)âï¿½ï¿½Â¦`
                                : status.tone === "returned"
                    ...
                    <div className="td-inline-reader">
                      <header className="td-inline-reader-head">
                        <div>
                          ...
                          <small>
                            {formatSize(latestSubmission.size)} ÃÂ· Submitted
                            document
                          </small>
                        </div>
                        <div>
                          <span>Ã¢ÅÂ¦ AI Summary</span>
                          <span>âï¿½ï¿½Â¢ PDF</span>
                          <button
                            type="button"
                            onClick={() =>
                              previewFile({
              ...
              <aside className="td-side">
                    ...
                    {isFacultyView ? (
                      ...
                      <>
                        ...
                        >
                          ...
                          {deciding ? "Savingâï¿½ï¿½Â¦" : "Approve task"}
                        </button>
                        <button
                          className="td-return"
                          type="button"
                  ...
                  {!isFacultyView && returnOpen && (
                    <form className="td-return-form" onSubmit={returnTask}>
                      ...
                      <textarea
                        ...
                        placeholder="Explain what needs to be corrected before the next submissionâï¿½ï¿½Â¦"
                        autoFocus
                      />
                      {returnError && (
                ...
                <section className="td-side-card">
                  ...
                  <div className="td-readiness">
                    ...
                    >
                      <b>{task.deadline || task.due_date ? "Ã¢Åâ" : ""}</b>{" "}
                      Deadline{" "}
                    ...
                    >
                      <b>{latestSubmission || selectedFile ? "Ã¢Åâ" : ""}</b>{" "}
                      Completed file{" "}
                      {latestSubmission
                        ? "submitted"
                        : selectedFile
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end" }}>
              ...
              >
                {confirmingCollaboration ? "Confirmingâï¿½ï¿½Â¦" : "Yes, confirm"}
              </button>
            </div>
          </div>
        </div>
