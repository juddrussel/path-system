  ...
  return (
    <div className="td-shell">
      <style>{`
        ...
        .td-shell{display:flex;min-height:100vh;background:#f8f7ff;color:#4a3a55;font-family:'DM Sans',sans-serif}.td-shell *{box-sizing:border-box}.td-main{display:flex;min-width:0;flex:1;flex-direction:column}.td-scroll{flex:1;overflow:auto;padding:28px 40px 44px}.td-page{max-width:none;margin:0 auto}.td-loading{display:flex;min-height:64vh;flex-direction:column;align-items:center;justify-content:center;gap:9px;color:#8d8098;font-size:13px}.td-loading strong{color:#574362;font:800 20px Manrope,sans-serif}.td-loading button{margin-top:8px;border:0;border-radius:8px;padding:9px 12px;background:#7c3aed;color:#fff;font:800 10px 'DM Sans',sans-serif;cursor:pointer}
