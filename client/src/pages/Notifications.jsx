...
export default function Notifications() {
  ...
  const styles = [
    "@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700;800&family=Manrope:wght@500;600;700;800&display=swap');.path-notifications-shell{display:flex;height:100vh;overflow:hidden;background:#f8f7ff;color:#2c2537;font-family:'DM Sans',sans-serif}.path-notifications-main{display:flex;flex:1;min-width:0;flex-direction:column;overflow:hidden}.path-notifications-content{flex:1;overflow-y:auto;padding:30px 54px 48px;background:linear-gradient(180deg,#faf9ff,#f8f7ff);box-sizing:border-box}@media(min-width:1100px){.path-notifications-content{padding-left:clamp(48px,5vw,84px);padding-right:clamp(48px,5vw,84px)}}.notifications-view{width:100%;max-width:none;margin:0 auto}.notifications-hero{display:flex;align-items:center;justify-content:space-between;gap:24px;min-height:148px;margin-bottom:18px;padding:29px 24px;border:1px solid #e6ddf5;border-left:2px solid #c4b5fd;border-radius:12px;background:linear-gradient(112deg,#fcfaff,#f5efff)}.date-kicker,.section-kicker{color:#8e8499;font:700 12px/1 'DM Sans';letter-spacing:.12em;text-transform:uppercase}.live-dot{display:inline-block;width:6px;height:6px;margin-right:8px;border-radius:50%;background:#8b5cf6;box-shadow:0 0 0 4px #eee8ff}.notifications-hero h1{margin:9px 0 7px;color:#2c2537;font:700 31px/1.12 'Manrope',sans-serif;letter-spacing:-.045em}.notifications-hero p{margin:0;color:#83778b;font:400 14px/1.4 'DM Sans'}.notifications-hero-actions,.notifications-unread-count{display:flex;align-items:center;gap:12px}.notifications-unread-count{color:#7c3aed}.notifications-unread-count strong{font:700 22px/1 'Manrope',sans-serif}.notifications-unread-count span{color:#83778b;font-size: 14px}.ghost-action{display:inline-flex;align-items:center;gap:7px;padding:10px 13px;border:1px solid #ddd6fe;border-radius:8px;background:#fff;color:#7c3aed;font:700 12px 'DM Sans';cursor:pointer}.notification-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin-bottom:18px}.notification-summary article{min-height:112px;padding:18px 17px;border:1px solid #e5deed;border-radius:9px;background:#fff;box-shadow:0 8px 20px #39245d09}.notification-summary span{color:#8f8797;font:700 12px 'DM Sans';letter-spacing:.12em;text-transform:uppercase}.notification-summary strong{display:block;margin:16px 0 8px;color:#332c3e;font:700 28px/1 'Manrope',sans-serif;letter-spacing:-.04em}.notification-summary small{color:#a49aa9;font-size: 14px}.notifications-layout{display:grid;align-items:start;grid-template-columns:minmax(0,1.65fr) minmax(310px,.8fr);gap:14px}.panel-card{border:1px solid #e5deed;border-radius:12px;background:#fff;box-shadow:0 12px 30px #39245d0b;overflow:hidden}.notifications-toolbar{display:flex;align-items:flex-end;justify-content:space-between;gap:18px;padding:20px 21px 16px;border-bottom:1px solid #f0edf4}.notifications-toolbar h2{margin:6px 0 4px;color:#393341;font:700 18px/1.15 'Manrope',sans-serif;letter-spacing:-.025em}.notifications-toolbar h2 span{display:inline-block;margin-left:5px;padding:3px 7px;border-radius:999px;background:#eee8ff;color:#7c3aed;font:700 12px 'DM Sans'}.notifications-toolbar p,.notification-preferences>p{margin:0;color:#9b91a3;font-size: 14px}.notifications-filter-controls{display:flex;gap:7px}.notifications-search{display:flex;align-items:center;gap:7px;min-width:190px;padding:8px 10px;border:1px solid #e7ddf1;border-radius:8px;background:#fff}.notifications-search input{width:100%;border:0;outline:0;font:400 12px 'DM Sans';color:#40364b}.notifications-filter-controls select{height:32px;padding:0 9px;border:1px solid #e7ddf1;border-radius:8px;background:#fff;color:#776b83;font:600 12px 'DM Sans'}.notification-group{padding:0 21px}.notification-group-label{padding:15px 0 8px;color:#a097a7;font:800 12px 'DM Sans';letter-spacing:.1em;text-transform:uppercase}.notification-row{display:flex;align-items:flex-start;gap:11px;width:100%;padding:15px 0;border:0;border-bottom:1px solid #f0edf4;background:#fff;text-align:left;cursor:pointer}.notification-icon{display:grid;width:32px;height:32px;flex:none;place-items:center;border-radius:9px;background:#f0eaff;color:#7c3aed}.notification-icon.red{background:#fff0f0;color:#c66a6a}.notification-icon.blue{background:#eef5ff;color:#4778ba}.notification-row-copy{display:flex;min-width:0;flex:1;flex-direction:column;gap:5px}.notification-row-copy>span{display:flex;justify-content:space-between;gap:10px}.notification-row-copy strong{color:#40364b;font:700 13px/1.3 'Manrope',sans-serif;letter-spacing:-.01em}.notification-row-copy small{color:#a49aa9;font-size: 14px}.notification-row-copy em{align-self:flex-start;padding:3px 7px;border-radius:999px;background:#f5f0ff;color:#7c3aed;font:700 11px 'DM Sans';font-style:normal;text-transform:uppercase}.notification-row-copy p{margin:0;color:#776b83;font-size: 14px;line-height:1.4}.notification-context{color:#a49aa9!important}.notification-unread-dot{width:6px;height:6px;margin-top:5px;border-radius:50%;background:#7c3aed}.notification-row.unread strong{color:#4c1d95}.notification-preferences{align-self:start;height:max-content;padding:20px 21px}.panel-topline{display:flex;justify-content:space-between}.panel-topline h3{margin:6px 0 0;color:#393341;font:700 17px/1.15 'Manrope',sans-serif;letter-spacing:-.025em}.notification-preference{display:flex;align-items:center;gap:10px;padding:14px 0;border-bottom:1px solid #f0edf4}.preference-icon{display:grid;width:30px;height:30px;flex:none;place-items:center;border-radius:9px;background:#f0eaff;color:#7c3aed}.notification-preference>span:nth-child(2){display:flex;flex:1;flex-direction:column;gap:4px}.notification-preference strong{color:#675a70;font:700 12px/1.2 'Manrope',sans-serif}.notification-preference small{font-size: 14px;color:#a49aa9}.notification-toggle{width:34px;height:19px;padding:2px;border:0;border-radius:999px;background:#e5e0eb;cursor:pointer}.notification-toggle.on{background:#7c3aed}.notification-toggle i{display:block;width:15px;height:15px;border-radius:50%;background:#fff;transition:transform .15s}.notification-toggle.on i{transform:translateX(15px)}.notification-preference-note{display:flex;gap:8px;margin:15px 0;padding:11px;border:1px solid #e7ddf1;border-radius:8px;background:#fbfaff;color:#8f8499;font-size: 14px;line-height:1.4}.text-action{display:inline-flex;align-items:center;gap:7px;padding:9px 0;border:0;background:none;color:#7c3aed;font:700 12px 'DM Sans';cursor:pointer}.notifications-empty{display:flex;align-items:center;flex-direction:column;gap:7px;padding:52px 20px;color:#a49aa9;text-align:center}.notifications-empty strong{font:700 13px/1.2 'Manrope',sans-serif;color:#675a70}.notifications-empty span{font-size: 14px}.notification-toast-stack{position:fixed;top:16px;right:16px;z-index:200;display:flex;flex-direction:column;gap:8px}.notification-toast{display:flex;align-items:flex-start;gap:10px;min-width:260px;max-width:340px;padding:10px 14px;border:1px solid #e5deed;border-radius:10px;background:#fff;box-shadow:0 4px 20px #0002}.notification-toast.high{background:#fff5f5;border-color:#fecaca}.notification-toast-icon{display:grid;width:26px;height:26px;place-items:center;border-radius:7px;background:#ede9fe;color:#7c3aed}.notification-toast>span:nth-child(2){display:flex;flex:1;flex-direction:column;gap:3px}.notification-toast strong{font:700 13px/1.2 'Manrope',sans-serif}.notification-toast small{font-size: 14px;color:#6b7280}.notification-toast button{border:0;background:none;color:#9ca3af;cursor:pointer}@media(max-width:1100px){.path-notifications-content{padding:24px 28px 40px}.notification-summary{grid-template-columns:repeat(2,minmax(0,1fr))}.notifications-layout{grid-template-columns:1fr}}@media(max-width:760px){.path-notifications-content{padding:18px 14px 32px}.notifications-hero{align-items:flex-start;flex-direction:column;padding:22px 18px}.notifications-hero-actions,.notifications-filter-controls{align-items:stretch;flex-direction:column;width:100%}.notifications-hero-actions .ghost-action,.notifications-filter-controls select{width:100%}.notification-summary{gap:8px}.notification-summary article{min-height:108px;padding:16px 14px}.notifications-toolbar{align-items:stretch;flex-direction:column}.notifications-search{min-width:0}.notification-row-copy>span{flex-direction:column}.notification-preferences{order:-1}}",
  ].join("");
  return (
