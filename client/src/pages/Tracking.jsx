...
function Avatar({ name, size = 28, color = "#7c3aed", src }) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: "50%", background: color, color: "white", display: "flex", alignItems: "center", justifyContent: "center", fontSize: size * 0.36, fontWeight: 700, flexShrink: 0, overflow: "hidden" }}>
      {showImg
        ? <img
            src={resolvedSrc}
            alt={name || "User"}
